...
//}
//ubo int UserUniforms 0:35:4816 {
//float4 sc_Time 1376
...
//float3x3 additional_settings_btn_refl_texTransform 4320
//float4 additional_settings_btn_refl_texUvMinMax 4368
//float4 additional_settings_btn_refl_texBorderColor 4384
//float3x3 iconTransform 4448
//float4 iconUvMinMax 4496
//float4 iconBorderColor 4512
//bool iconEnabled 4528
//float Port_Import_N006 4532
//float3 Port_Import_N049 4544
//float Port_Input1_N053 4560
//float Port_Input2_N053 4564
//float Port_Import_N062 4568
//float3 Port_Import_N068 4576
//float Port_Input1_N073 4592
//float Port_Input2_N073 4596
//float Port_Input2_N005 4600
//float2 Port_Input1_N009 4608
//float2 Port_Input2_N009 4616
...
//float Port_Value0_N018 4720
//float Port_Position1_N018 4724
//float Port_Value1_N018 4728
//float Port_Position2_N018 4732
//float Port_Value2_N018 4736
//float Port_Position3_N018 4740
//float Port_Value3_N018 4744
//float Port_Value4_N018 4748
//float4 Port_Input1_N034 4752
//float3 Port_Normal_N031 4768
//float Port_Exponent_N031 4784
//float Port_Intensity_N031 4788
//float2 Port_Scale_N002 4792
//float2 Port_Center_N002 4800
//float Port_Input2_N003 4808
//float depthRef 4812
//}
...
//spec_const bool sc_BlendMode_Software 59 0
...
//spec_const bool sc_IsEditor 63 0
...
//spec_const bool sc_ProxyAlphaOne 70 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex 78 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_icon 79 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 80 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex 81 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_icon 82 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 83 -1
//spec_const int additional_settings_btn_refl_texLayout 84 0
//spec_const int iconLayout 85 0
...
constant bool sc_BlendMode_Software [[function_constant(59)]];
...
constant bool sc_GetFramebufferColorInvalidUsageMarker [[function_constant(62)]];
...
constant bool sc_IsEditor [[function_constant(63)]];
...
constant bool sc_ProxyAlphaOne [[function_constant(70)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_additional_settings_btn_refl_tex [[function_constant(78)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_icon [[function_constant(79)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_additional_settings_btn_refl_tex [[function_constant(81)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_icon [[function_constant(82)]];
...
constant int additional_settings_btn_refl_texLayout [[function_constant(84)]];
...
constant int iconLayout [[function_constant(85)]];
...
int l9_9=l9_8;
VectorOut_N52=((*sc_set0.UserUniforms).sc_ViewMatrixArray[l9_9]*float4(Output_N51,0.0)).xyz;
...
float param_12=0.0;
bool l9_16=param_10&&(!param_8);
float l9_17=1.0;
float l9_18=param_4.x;
int l9_19=param_7.x;
if (l9_19==1)
{
l9_18=fract(l9_18);
...
float l9_30=param_4.x;
float l9_31=param_9.x;
float l9_32=param_9.z;
bool l9_33=l9_29;
float l9_34=l9_17;
...
float l9_39=param_4.y;
float l9_40=param_9.y;
float l9_41=param_9.w;
bool l9_42=l9_38;
float l9_43=l9_17;
...
float2 l9_46=param_4;
bool l9_47=param_5;
float3x3 l9_48=param_6;
if (l9_47)
{
...
param_4.y=l9_63;
l9_17=l9_66;
float2 l9_74=param_4;
int l9_75=param_2;
int l9_76=param_3;
float l9_77=param_12;
float2 l9_78=l9_74;
int l9_79=l9_75;
int l9_80=l9_76;
...
float l9_85=l9_77;
float4 l9_86=sc_set0.additional_settings_btn_refl_tex.sample(sc_set0.additional_settings_btn_refl_texSmpSC,l9_84,bias(l9_85));
float4 l9_87=l9_86;
float4 l9_88=l9_87;
if (param_10)
{
l9_88=mix(param_11,l9_88,float4(l9_17));
}
float4 l9_89=l9_88;
Color_N57=l9_89;
...
float l9_90=dot(param_13,param_13);
float l9_91;
if (l9_90>0.0)
{
l9_91=1.0/sqrt(l9_90);
}
else
{
l9_91=0.0;
...
float l9_92=l9_91;
float3 param_14=param_13*l9_92;
Output_N70=param_14;
...
int l9_94=l9_93;
VectorOut_N71=((*sc_set0.UserUniforms).sc_ViewMatrixArray[l9_94]*float4(Output_N70,0.0)).xyz;
...
float param_25=0.0;
bool l9_101=param_23&&(!param_21);
float l9_102=1.0;
float l9_103=param_17.x;
int l9_104=param_20.x;
if (l9_104==1)
{
l9_103=fract(l9_103);
}
...
param_17.x=l9_103;
float l9_108=param_17.y;
int l9_109=param_20.y;
if (l9_109==1)
{
l9_108=fract(l9_108);
}
...
float l9_116=param_22.x;
float l9_117=param_22.z;
bool l9_118=l9_114;
float l9_119=l9_102;
...
float l9_124=param_17.y;
float l9_125=param_22.y;
float l9_126=param_22.w;
bool l9_127=l9_123;
float l9_128=l9_102;
...
float2 l9_131=param_17;
bool l9_132=param_18;
float3x3 l9_133=param_19;
if (l9_132)
{
...
param_17=l9_136;
float l9_137=param_17.x;
int l9_138=param_20.x;
bool l9_139=l9_101;
float l9_140=l9_102;
...
param_17.x=l9_137;
l9_102=l9_140;
float l9_148=param_17.y;
int l9_149=param_20.y;
bool l9_150=l9_101;
float l9_151=l9_102;
...
float l9_170=l9_162;
float4 l9_171=sc_set0.additional_settings_btn_refl_tex.sample(sc_set0.additional_settings_btn_refl_texSmpSC,l9_169,bias(l9_170));
float4 l9_172=l9_171;
float4 l9_173=l9_172;
if (param_23)
{
l9_173=mix(param_24,l9_173,float4(l9_102));
}
...
float4 param_27=(*sc_set0.UserUniforms).Port_Value0_N007;
float param_28=(*sc_set0.UserUniforms).Port_Position1_N007;
float4 param_29=(*sc_set0.UserUniforms).Port_Value1_N007;
float param_30=(*sc_set0.UserUniforms).Port_Position2_N007;
float4 param_31=(*sc_set0.UserUniforms).Port_Value2_N007;
float4 param_32=(*sc_set0.UserUniforms).Port_Value3_N007;
...
bool l9_175=(*sc_set0.UserUniforms).PreviewEnabled==1;
bool l9_176;
if (l9_175)
{
l9_176=!PreviewInfo.Saved;
}
else
{
l9_176=l9_175;
...
if (l9_176)
{
l9_177=7==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_177=l9_176;
...
float param_35=(*sc_set0.UserUniforms).Port_Value0_N018;
float param_36=(*sc_set0.UserUniforms).Port_Position1_N018;
float param_37=(*sc_set0.UserUniforms).Port_Value1_N018;
float param_38=(*sc_set0.UserUniforms).Port_Position2_N018;
float param_39=(*sc_set0.UserUniforms).Port_Value2_N018;
float param_40=(*sc_set0.UserUniforms).Port_Position3_N018;
float param_41=(*sc_set0.UserUniforms).Port_Value3_N018;
float param_42=(*sc_set0.UserUniforms).Port_Value4_N018;
...
float Rim_N31=0.0;
float3 param_44=(*sc_set0.UserUniforms).Port_Normal_N031;
float param_45=(*sc_set0.UserUniforms).Port_Exponent_N031;
float param_46=(*sc_set0.UserUniforms).Port_Intensity_N031;
...
float l9_178=abs(dot(-param_48.ViewDirWS,param_44));
float param_47=pow(1.0-l9_178,param_45);
param_47=fast::max(param_47,0.0);
param_47*=param_46;
Rim_N31=param_47;
float4 Output_N34=float4(0.0);
Output_N34=mix(Value_N23,(*sc_set0.UserUniforms).Port_Input1_N034,float4(Rim_N31));
...
float3x3 param_53=(*sc_set0.UserUniforms).iconTransform;
...
float4 param_56=(*sc_set0.UserUniforms).iconUvMinMax;
bool param_57=(int(SC_USE_CLAMP_TO_BORDER_icon_tmp)!=0);
float4 param_58=(*sc_set0.UserUniforms).iconBorderColor;
float param_59=0.0;
bool l9_185=param_57&&(!param_55);
float l9_186=1.0;
float l9_187=param_51.x;
int l9_188=param_54.x;
if (l9_188==1)
{
l9_187=fract(l9_187);
}
...
param_51.x=l9_187;
float l9_192=param_51.y;
int l9_193=param_54.y;
if (l9_193==1)
{
l9_192=fract(l9_192);
}
...
float l9_199=param_51.x;
float l9_200=param_56.x;
float l9_201=param_56.z;
bool l9_202=l9_198;
float l9_203=l9_186;
...
float l9_208=param_51.y;
float l9_209=param_56.y;
float l9_210=param_56.w;
bool l9_211=l9_207;
float l9_212=l9_186;
...
float2 l9_215=param_51;
bool l9_216=param_52;
float3x3 l9_217=param_53;
if (l9_216)
{
...
param_51=l9_220;
float l9_221=param_51.x;
int l9_222=param_54.x;
bool l9_223=l9_185;
float l9_224=l9_186;
...
param_51.x=l9_221;
l9_186=l9_224;
float l9_232=param_51.y;
int l9_233=param_54.y;
bool l9_234=l9_185;
float l9_235=l9_186;
...
param_51.y=l9_232;
l9_186=l9_235;
float2 l9_243=param_51;
int l9_244=param_49;
int l9_245=param_50;
float l9_246=param_59;
...
float l9_254=l9_246;
float4 l9_255=sc_set0.icon.sample(sc_set0.iconSmpSC,l9_253,bias(l9_254));
float4 l9_256=l9_255;
float4 l9_257=l9_256;
if (param_57)
{
l9_257=mix(param_58,l9_257,float4(l9_186));
}
...
float param_60=1.0;
float param_61=1.0;
float param_62=(*sc_set0.UserUniforms).Port_Input2_N003;
ssGlobals param_64=Globals;
float l9_259=0.0;
float l9_260=float((*sc_set0.UserUniforms).iconEnabled!=0);
l9_259=l9_260;
param_60=l9_259;
float param_63;
if ((param_60*1.0)!=0.0)
...
l9_261=param_64.Surface_UVCoord1;
...
int l9_269=l9_264;
int l9_270=iconLayout_tmp;
int l9_271=l9_269;
float2 l9_272=l9_262;
bool l9_273=(int(SC_USE_UV_TRANSFORM_icon_tmp)!=0);
float3x3 l9_274=(*sc_set0.UserUniforms).iconTransform;
int2 l9_275=int2(SC_SOFTWARE_WRAP_MODE_U_icon_tmp,SC_SOFTWARE_WRAP_MODE_V_icon_tmp);
bool l9_276=(int(SC_USE_UV_MIN_MAX_icon_tmp)!=0);
float4 l9_277=(*sc_set0.UserUniforms).iconUvMinMax;
bool l9_278=(int(SC_USE_CLAMP_TO_BORDER_icon_tmp)!=0);
float4 l9_279=(*sc_set0.UserUniforms).iconBorderColor;
float l9_280=0.0;
...
float l9_350=l9_342;
float4 l9_351=sc_set0.icon.sample(sc_set0.iconSmpSC,l9_349,bias(l9_350));
...
l9_263=l9_354;
float l9_355=0.0;
float4 l9_356=l9_263;
float l9_357=l9_356.w;
l9_355=l9_357;
param_61=l9_355;
param_63=param_61;
}
...
{
if (param_65<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
float2 l9_359=floor(mod(l9_358.xy,float2(4.0)));
float l9_360=(mod(dot(l9_359,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_65<l9_360)
{
discard_fragment();
}
}
bool l9_361=(*sc_set0.UserUniforms).isProxyMode!=0;
if (l9_361)
{
...
float4 l9_362=fast::max(param_66,float4(0.0));
float4 param_67=l9_362;
if (sc_ShaderCacheConstant_tmp!=0)
{
param_67.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
...
{
l9_365=fast::clamp(l9_364.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_365=fast::clamp(dot(l9_364.xyz,float3(l9_364.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_365=(1.0-dot(l9_364.xyz,float3(0.33333001)))*l9_364.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_365=(1.0-fast::clamp(dot(l9_364.xyz,float3(1.0)),0.0,1.0))*l9_364.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_365=fast::clamp(dot(l9_364.xyz,float3(1.0)),0.0,1.0)*l9_364.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_365=fast::clamp(dot(l9_364.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_365=dot(l9_364.xyz,float3(0.33333001))*l9_364.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_365=1.0-fast::clamp(dot(l9_364.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_366=l9_365;
float l9_367=l9_366;
float l9_368=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_367;
float3 l9_369=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_363.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_370=float4(l9_369.x,l9_369.y,l9_369.z,l9_368);
param_68=l9_370;
}
else
{
...
{
float4 l9_371=param_68;
float4 l9_372=float4(0.0);
float4 l9_373=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_374=out.FragColor0;
float4 l9_375=l9_374;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_375.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
...
{
float4 l9_377=gl_FragCoord;
float2 l9_378=l9_377.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_383=l9_382;
int l9_384=l9_383;
float3 l9_385=float3(l9_379,0.0);
int l9_386=l9_381;
int l9_387=l9_384;
if (l9_386==1)
{
l9_385.y=((2.0*l9_385.y)+float(l9_387))-1.0;
}
float2 l9_388=l9_385.xy;
l9_380=l9_388;
}
else
{
...
int l9_397=l9_392;
float2 l9_398=l9_391;
int l9_399=l9_397;
float2 l9_400=l9_398;
int l9_401=l9_399;
float l9_402=0.0;
float4 l9_403=float4(0.0);
float2 l9_404=l9_400;
int l9_405=sc_ScreenTextureLayout_tmp;
int l9_406=l9_401;
float l9_407=l9_402;
...
float l9_415=l9_407;
float4 l9_416=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_414,bias(l9_415));
...
{
l9_373.x+=(*sc_set0.UserUniforms)._sc_GetFramebufferColorInvalidUsageMarker;
}
float4 l9_421=l9_373;
float4 l9_422=l9_421;
float3 l9_423=l9_422.xyz;
float3 l9_424=l9_423;
float3 l9_425=l9_371.xyz;
float3 l9_426=definedBlend(l9_424,l9_425,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_372=float4(l9_426.x,l9_426.y,l9_426.z,l9_372.w);
float3 l9_427=mix(l9_423,l9_372.xyz,float3(l9_371.w));
l9_372=float4(l9_427.x,l9_427.y,l9_427.z,l9_372.w);
l9_372.w=1.0;
float4 l9_428=l9_372;
param_68=l9_428;
}
else
{
float4 l9_429=param_68;
float4 l9_430=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_430=float4(mix(float3(1.0),l9_429.xyz,float3(l9_429.w)),l9_429.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_431=l9_429.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_431=fast::clamp(l9_431,0.0,1.0);
}
l9_430=float4(l9_429.xyz*l9_431,l9_431);
}
else
{
l9_430=l9_429;
...
{
l9_434=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_434=float4(0.0);
...
FinalColor=outputMotionVectorsIfNeeded(param_69,param_70,in.varStereoViewID,(*sc_set0.UserUniforms));
float4 param_71=FinalColor;
float4 l9_436=param_71;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_436.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_436;
return out;
}
} // FRAGMENT SHADER
