...
//float4 Port_Value0_N003 4624
//float Port_Position1_N003 4640
//float4 Port_Value1_N003 4656
//float Port_Position2_N003 4672
//float4 Port_Value2_N003 4688
//float Port_Position3_N003 4704
//float4 Port_Value3_N003 4720
//float4 Port_Value4_N003 4736
...
if (l9_176)
{
l9_177=3==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_177=l9_176;
...
Value_N3=param_35;
float Rim_N31=0.0;
float3 param_36=(*sc_set0.UserUniforms).Port_Normal_N031;
float param_37=(*sc_set0.UserUniforms).Port_Exponent_N031;
float param_38=(*sc_set0.UserUniforms).Port_Intensity_N031;
...
float l9_178=abs(dot(-param_40.ViewDirWS,param_36));
float param_39=pow(1.0-l9_178,param_37);
param_39=fast::max(param_39,0.0);
param_39*=param_38;
Rim_N31=param_39;
float4 Output_N24=float4(0.0);
Output_N24=mix(Value_N3,(*sc_set0.UserUniforms).Port_Input1_N024,float4(Rim_N31));
...
float3x3 param_45=(*sc_set0.UserUniforms).iconTransform;
...
float4 param_48=(*sc_set0.UserUniforms).iconUvMinMax;
bool param_49=(int(SC_USE_CLAMP_TO_BORDER_icon_tmp)!=0);
float4 param_50=(*sc_set0.UserUniforms).iconBorderColor;
float param_51=0.0;
bool l9_185=param_49&&(!param_47);
float l9_186=1.0;
float l9_187=param_43.x;
int l9_188=param_46.x;
if (l9_188==1)
{
l9_187=fract(l9_187);
}
...
param_43.x=l9_187;
float l9_192=param_43.y;
int l9_193=param_46.y;
if (l9_193==1)
{
l9_192=fract(l9_192);
}
...
float l9_199=param_43.x;
float l9_200=param_48.x;
float l9_201=param_48.z;
bool l9_202=l9_198;
float l9_203=l9_186;
...
float l9_208=param_43.y;
float l9_209=param_48.y;
float l9_210=param_48.w;
bool l9_211=l9_207;
float l9_212=l9_186;
...
float2 l9_215=param_43;
bool l9_216=param_44;
float3x3 l9_217=param_45;
if (l9_216)
{
...
param_43=l9_220;
float l9_221=param_43.x;
int l9_222=param_46.x;
bool l9_223=l9_185;
float l9_224=l9_186;
...
param_43.x=l9_221;
l9_186=l9_224;
float l9_232=param_43.y;
int l9_233=param_46.y;
bool l9_234=l9_185;
float l9_235=l9_186;
...
param_43.y=l9_232;
l9_186=l9_235;
float2 l9_243=param_43;
int l9_244=param_41;
int l9_245=param_42;
float l9_246=param_51;
...
if (param_49)
{
l9_257=mix(param_50,l9_257,float4(l9_186));
}
...
float param_52=1.0;
float param_53=1.0;
float param_54=(*sc_set0.UserUniforms).Port_Input2_N007;
...
l9_261=param_56.Surface_UVCoord1;
...
float4 l9_362=fast::max(param_58,float4(0.0));
float4 param_59=l9_362;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
FinalColor=outputMotionVectorsIfNeeded(param_61,param_62,in.varStereoViewID,(*sc_set0.UserUniforms));
float4 param_63=FinalColor;
float4 l9_436=param_63;
if (sc_ShaderCacheConstant_tmp!=0)
{
