...
//sampler sampler Tweak_N25SmpSC 0:18
//sampler sampler Tweak_N6SmpSC 0:19
//sampler sampler intensityTextureSmpSC 0:20
//sampler sampler planet_refl_mapSmpSC 0:21
//sampler sampler sc_OITCommonSampler 0:24
//sampler sampler sc_ScreenTextureSmpSC 0:26
//texture texture2D Tweak_N25 0:0:0:18
//texture texture2D Tweak_N6 0:1:0:19
//texture texture2D intensityTexture 0:2:0:20
//texture texture2D planet_refl_map 0:3:0:21
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N25 87 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N6 88 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 89 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_planet_refl_map 90 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N25 91 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N6 92 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 93 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_planet_refl_map 94 -1
//spec_const int Tweak_N25Layout 95 0
//spec_const int Tweak_N6Layout 96 0
//spec_const int intensityTextureLayout 97 0
//spec_const int planet_refl_mapLayout 98 0
...
ssGlobals l9_4=ssGlobals(sc_Time.x,sc_Time.y,0.0,l9_0,l9_1,l9_2,l9_3,varPos,varPackedTex.xy,varPackedTex.zw);
vec3 l9_5=normalize(-l9_3);
vec3 l9_6=normalize(cross(l9_5,sc_ViewMatrixInverseArray[sc_GetStereoViewIndex()][1].xyz));
vec3 l9_7=cross(l9_6,l9_5);
vec2 l9_8=((mat3(vec3(l9_6.x,l9_7.x,l9_5.x),vec3(l9_6.y,l9_7.y,l9_5.y),vec3(l9_6.z,l9_7.z,l9_5.z))*normalize(mat3(l9_1,l9_2,l9_0)*Port_Import_N013)).xy*0.5)+vec2(0.5);
int l9_9;
...
#endif
bool l9_10=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_planet_refl_map)!=0));
float l9_11=l9_8.x;
sc_SoftwareWrapEarly(l9_11,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x);
float l9_12=l9_11;
float l9_13=l9_8.y;
sc_SoftwareWrapEarly(l9_13,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y);
float l9_14=l9_13;
vec2 l9_15;
float l9_16;
...
{
l9_17=ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x==3;
}
#else
{
...
float l9_18=l9_12;
float l9_19=1.0;
sc_ClampUV(l9_18,planet_refl_mapUvMinMax.x,planet_refl_mapUvMinMax.z,l9_17,l9_19);
float l9_20=l9_18;
float l9_21=l9_19;
bool l9_22;
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
l9_22=ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y==3;
}
#else
{
l9_22=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0);
}
#endif
float l9_23=l9_14;
float l9_24=l9_21;
sc_ClampUV(l9_23,planet_refl_mapUvMinMax.y,planet_refl_mapUvMinMax.w,l9_22,l9_24);
l9_16=l9_24;
...
#endif
vec2 l9_25=sc_TransformUV(l9_15,(int(SC_USE_UV_TRANSFORM_planet_refl_map)!=0),planet_refl_mapTransform);
float l9_26=l9_25.x;
float l9_27=l9_16;
sc_SoftwareWrapLate(l9_26,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x,l9_10,l9_27);
float l9_28=l9_25.y;
float l9_29=l9_27;
sc_SoftwareWrapLate(l9_28,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y,l9_10,l9_29);
float l9_30=l9_29;
vec3 l9_31=sc_SamplingCoordsViewToGlobal(vec2(l9_26,l9_28),planet_refl_mapLayout,l9_9);
vec4 l9_32=texture2D(planet_refl_map,l9_31.xy,0.0);
vec4 l9_33;
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
l9_33=mix(planet_refl_mapBorderColor,l9_32,vec4(l9_30));
}
#else
{
l9_33=l9_32;
...
#endif
vec4 l9_34=vec4(reflIntensity)*l9_33;
vec4 l9_35;
#if (Tweak_N37)
{
vec2 l9_36;
Node3_Rotate_Coords(varPackedTex.xy,Port_Rotation_N003,Port_Center_N003,l9_36,l9_4);
vec4 l9_37;
Node0_Gradient(l9_36.x,Tweak_N2,colorRatio,Tweak_N8,Tweak_N9,l9_37,l9_4);
vec4 l9_38=l9_37;
vec2 l9_39=(((varPackedTex.xy+Port_Offset_N062)-Port_Center_N060)*vec2(Tweak_N66*Tweak_N64,Tweak_N64))+Port_Center_N060;
int l9_40;
...
#endif
bool l9_41=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N25)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N25)!=0));
float l9_42=l9_39.x;
sc_SoftwareWrapEarly(l9_42,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N25,SC_SOFTWARE_WRAP_MODE_V_Tweak_N25).x);
float l9_43=l9_42;
float l9_44=l9_39.y;
sc_SoftwareWrapEarly(l9_44,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N25,SC_SOFTWARE_WRAP_MODE_V_Tweak_N25).y);
float l9_45=l9_44;
vec2 l9_46;
float l9_47;
#if (SC_USE_UV_MIN_MAX_Tweak_N25)
{
bool l9_48;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N25)
{
l9_48=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N25,SC_SOFTWARE_WRAP_MODE_V_Tweak_N25).x==3;
}
#else
{
l9_48=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N25)!=0);
}
#endif
float l9_49=l9_43;
float l9_50=1.0;
sc_ClampUV(l9_49,Tweak_N25UvMinMax.x,Tweak_N25UvMinMax.z,l9_48,l9_50);
float l9_51=l9_49;
float l9_52=l9_50;
bool l9_53;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N25)
{
l9_53=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N25,SC_SOFTWARE_WRAP_MODE_V_Tweak_N25).y==3;
}
#else
{
l9_53=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N25)!=0);
}
#endif
float l9_54=l9_45;
float l9_55=l9_52;
sc_ClampUV(l9_54,Tweak_N25UvMinMax.y,Tweak_N25UvMinMax.w,l9_53,l9_55);
l9_47=l9_55;
...
#endif
vec2 l9_56=sc_TransformUV(l9_46,(int(SC_USE_UV_TRANSFORM_Tweak_N25)!=0),Tweak_N25Transform);
float l9_57=l9_56.x;
float l9_58=l9_47;
sc_SoftwareWrapLate(l9_57,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N25,SC_SOFTWARE_WRAP_MODE_V_Tweak_N25).x,l9_41,l9_58);
float l9_59=l9_56.y;
float l9_60=l9_58;
sc_SoftwareWrapLate(l9_59,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N25,SC_SOFTWARE_WRAP_MODE_V_Tweak_N25).y,l9_41,l9_60);
float l9_61=l9_60;
vec3 l9_62=sc_SamplingCoordsViewToGlobal(vec2(l9_57,l9_59),Tweak_N25Layout,l9_40);
vec4 l9_63=texture2D(Tweak_N25,l9_62.xy,0.0);
vec4 l9_64;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N25)
{
l9_64=mix(Tweak_N25BorderColor,l9_63,vec4(l9_61));
}
#else
{
l9_64=l9_63;
...
#endif
l9_35=vec4(mix(l9_38.xyz,l9_64.xyz,vec3(l9_64.w)),0.0);
}
#else
{
vec2 l9_65;
Node3_Rotate_Coords(varPackedTex.xy,Port_Rotation_N003,Port_Center_N003,l9_65,l9_4);
vec4 l9_66;
Node0_Gradient(l9_65.x,Tweak_N2,colorRatio,Tweak_N8,Tweak_N9,l9_66,l9_4);
l9_35=l9_66;
}
#endif
vec4 l9_67=l9_34+l9_35;
int l9_68;
...
#endif
bool l9_69=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N6)!=0));
float l9_70=varPackedTex.z;
sc_SoftwareWrapEarly(l9_70,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x);
float l9_71=l9_70;
float l9_72=varPackedTex.w;
sc_SoftwareWrapEarly(l9_72,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y);
float l9_73=l9_72;
vec2 l9_74;
float l9_75;
...
{
l9_76=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x==3;
}
#else
{
l9_76=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0);
}
#endif
float l9_77=l9_71;
float l9_78=1.0;
sc_ClampUV(l9_77,Tweak_N6UvMinMax.x,Tweak_N6UvMinMax.z,l9_76,l9_78);
float l9_79=l9_77;
float l9_80=l9_78;
bool l9_81;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_81=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y==3;
}
#else
{
l9_81=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0);
}
#endif
float l9_82=l9_73;
float l9_83=l9_80;
sc_ClampUV(l9_82,Tweak_N6UvMinMax.y,Tweak_N6UvMinMax.w,l9_81,l9_83);
l9_75=l9_83;
...
#endif
vec2 l9_84=sc_TransformUV(l9_74,(int(SC_USE_UV_TRANSFORM_Tweak_N6)!=0),Tweak_N6Transform);
float l9_85=l9_84.x;
float l9_86=l9_75;
sc_SoftwareWrapLate(l9_85,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x,l9_69,l9_86);
float l9_87=l9_84.y;
float l9_88=l9_86;
sc_SoftwareWrapLate(l9_87,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y,l9_69,l9_88);
float l9_89=l9_88;
vec3 l9_90=sc_SamplingCoordsViewToGlobal(vec2(l9_85,l9_87),Tweak_N6Layout,l9_68);
vec4 l9_91=texture2D(Tweak_N6,l9_90.xy,0.0);
vec4 l9_92;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_92=mix(Tweak_N6BorderColor,l9_91,vec4(l9_89));
}
#else
{
l9_92=l9_91;
...
#endif
vec3 l9_93=l9_67.xyz;
vec3 l9_94=mix(l9_93,(l9_92.xyz*l9_93).xyz,vec3(l9_92.w));
vec4 l9_95=vec4(l9_94.x,l9_94.y,l9_94.z,vec4(0.0).w);
l9_95.w=Port_Value2_N053;
...
{
l9_98=clamp(Port_Value2_N053*2.0,0.0,1.0);
}
#else
{
float l9_99;
...
{
l9_99=clamp(dot(l9_95.xyz,vec3(Port_Value2_N053)),0.0,1.0);
}
#else
{
float l9_100;
...
{
l9_101=(1.0-dot(l9_95.xyz,vec3(0.33333001)))*Port_Value2_N053;
}
#else
{
float l9_102;
...
{
l9_102=(1.0-clamp(dot(l9_95.xyz,vec3(1.0)),0.0,1.0))*Port_Value2_N053;
}
#else
{
float l9_103;
...
{
l9_103=clamp(dot(l9_95.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N053;
}
#else
{
float l9_104;
#if (sc_BlendMode_Add)
{
l9_104=clamp(dot(l9_95.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_105;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_105=clamp(dot(l9_95.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N053;
}
#else
{
float l9_106;
...
{
l9_106=dot(l9_95.xyz,vec3(0.33333001))*Port_Value2_N053;
}
#else
{
float l9_107;
#if (sc_BlendMode_Min)
{
l9_107=1.0-clamp(dot(l9_95.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_108;
#if (sc_BlendMode_Max)
{
l9_108=clamp(dot(l9_95.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_108=1.0;
...
#endif
l9_96=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_95.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_97);
}
#else
{
vec4 l9_109;
...
#endif
vec3 l9_119=mix(l9_117.xyz,definedBlend(l9_117.xyz,l9_95.xyz).xyz,vec3(Port_Value2_N053));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_121=vec4(mix(vec3(1.0),l9_95.xyz,vec3(Port_Value2_N053)),Port_Value2_N053);
}
#else
{
vec4 l9_122;
...
{
l9_123=clamp(Port_Value2_N053,0.0,1.0);
}
#else
{
l9_123=Port_Value2_N053;
}
#endif
l9_122=vec4(l9_95.xyz*l9_123,l9_123);
}
#else
{
l9_122=l9_95;
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_130-0.0039215689)),min(1.0,l9_130+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_132),packValue(l9_132),packValue(l9_132),packValue(l9_132)),sc_UniformConstants.x,sc_ShaderCacheConstant);
