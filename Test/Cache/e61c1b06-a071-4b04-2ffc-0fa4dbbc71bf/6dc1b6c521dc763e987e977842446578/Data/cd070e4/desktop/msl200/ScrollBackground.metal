...
//}
//ubo int UserUniforms 0:31:4592 {
//float4 sc_Time 1376
...
//float size 4280
//float scale 4284
//float Port_Input1_N049 4288
//float Port_RangeMinA_N035 4292
//float Port_RangeMaxA_N035 4296
//float Port_RangeMinA_N050 4300
//float Port_RangeMaxA_N050 4304
//float Port_RangeMinB_N050 4308
//float Port_RangeMaxB_N050 4312
//float Port_RangeMinA_N048 4316
//float Port_RangeMaxA_N048 4320
//float Port_RangeMinB_N048 4324
//float Port_RangeMaxB_N048 4328
//float Port_Value2_N034 4332
//float Port_RangeMinA_N046 4336
//float Port_RangeMaxA_N046 4340
//float Port_RangeMinB_N046 4344
//float Port_RangeMaxB_N046 4348
//float2 Port_Center_N039 4352
//float4 Port_Value0_N040 4368
//float Port_Position1_N040 4384
//float4 Port_Value1_N040 4400
//float Port_Position2_N040 4416
//float4 Port_Value2_N040 4432
//float Port_Position3_N040 4448
//float4 Port_Value3_N040 4464
//float Port_Position4_N040 4480
//float4 Port_Value4_N040 4496
//float Port_Position5_N040 4512
//float4 Port_Value5_N040 4528
//float4 Port_Value6_N040 4544
//float4 Port_Value_N005 4560
//float depthRef 4576
//}
...
float l9_5=0.0;
float l9_6=(*sc_set0.UserUniforms).status;
l9_5=l9_6;
param=l9_5;
float4 param_3;
if ((param*1.0)!=0.0)
...
l9_7=param_4.SurfacePosition_ObjectSpace;
float l9_8=0.0;
float3 l9_9=l9_7;
float l9_10=l9_9.y;
l9_8=l9_10;
float l9_11=0.0;
l9_11=l9_8*(*sc_set0.UserUniforms).Port_Input1_N049;
float l9_12=0.0;
float l9_13=(*sc_set0.UserUniforms).offset;
l9_12=l9_13;
float l9_14=0.0;
float l9_15=(*sc_set0.UserUniforms).size;
l9_14=l9_15;
float l9_16=0.0;
l9_16=(((l9_14-(*sc_set0.UserUniforms).Port_RangeMinA_N050)/(((*sc_set0.UserUniforms).Port_RangeMaxA_N050-(*sc_set0.UserUniforms).Port_RangeMinA_N050)+1e-06))*((*sc_set0.UserUniforms).Port_RangeMaxB_N050-(*sc_set0.UserUniforms).Port_RangeMinB_N050))+(*sc_set0.UserUniforms).Port_RangeMinB_N050;
float l9_17=0.0;
l9_17=(((l9_14-(*sc_set0.UserUniforms).Port_RangeMinA_N048)/(((*sc_set0.UserUniforms).Port_RangeMaxA_N048-(*sc_set0.UserUniforms).Port_RangeMinA_N048)+1e-06))*((*sc_set0.UserUniforms).Port_RangeMaxB_N048-(*sc_set0.UserUniforms).Port_RangeMinB_N048))+(*sc_set0.UserUniforms).Port_RangeMinB_N048;
float l9_18=0.0;
l9_18=(((l9_12-(*sc_set0.UserUniforms).Port_RangeMinA_N035)/(((*sc_set0.UserUniforms).Port_RangeMaxA_N035-(*sc_set0.UserUniforms).Port_RangeMinA_N035)+1e-06))*(l9_17-l9_16))+l9_16;
float2 l9_19=float2(0.0);
l9_19.x=l9_18;
l9_19.y=(*sc_set0.UserUniforms).Port_Value2_N034;
float2 l9_20=float2(0.0);
l9_20=float2(l9_11)+l9_19;
float l9_21=0.0;
float l9_22=(*sc_set0.UserUniforms).scale;
l9_21=l9_22;
float l9_23=0.0;
l9_23=(((l9_21-(*sc_set0.UserUniforms).Port_RangeMinA_N046)/(((*sc_set0.UserUniforms).Port_RangeMaxA_N046-(*sc_set0.UserUniforms).Port_RangeMinA_N046)+1e-06))*((*sc_set0.UserUniforms).Port_RangeMaxB_N046-(*sc_set0.UserUniforms).Port_RangeMinB_N046))+(*sc_set0.UserUniforms).Port_RangeMinB_N046;
float2 l9_24=float2(0.0);
l9_24=((l9_20-(*sc_set0.UserUniforms).Port_Center_N039)*float2(l9_23))+(*sc_set0.UserUniforms).Port_Center_N039;
float4 l9_25=float4(0.0);
float l9_26=l9_24.x;
float4 l9_27=(*sc_set0.UserUniforms).Port_Value0_N040;
float l9_28=(*sc_set0.UserUniforms).Port_Position1_N040;
float4 l9_29=(*sc_set0.UserUniforms).Port_Value1_N040;
float l9_30=(*sc_set0.UserUniforms).Port_Position2_N040;
float4 l9_31=(*sc_set0.UserUniforms).Port_Value2_N040;
float l9_32=(*sc_set0.UserUniforms).Port_Position3_N040;
float4 l9_33=(*sc_set0.UserUniforms).Port_Value3_N040;
float l9_34=(*sc_set0.UserUniforms).Port_Position4_N040;
float4 l9_35=(*sc_set0.UserUniforms).Port_Value4_N040;
float l9_36=(*sc_set0.UserUniforms).Port_Position5_N040;
float4 l9_37=(*sc_set0.UserUniforms).Port_Value5_N040;
float4 l9_38=(*sc_set0.UserUniforms).Port_Value6_N040;
l9_26=fast::clamp(l9_26,0.0,1.0);
float4 l9_39;
if (l9_26<l9_28)
{
l9_39=mix(l9_27,l9_29,float4(fast::clamp(l9_26/l9_28,0.0,1.0)));
}
else
{
if (l9_26<l9_30)
{
l9_39=mix(l9_29,l9_31,float4(fast::clamp((l9_26-l9_28)/(l9_30-l9_28),0.0,1.0)));
}
else
{
if (l9_26<l9_32)
{
l9_39=mix(l9_31,l9_33,float4(fast::clamp((l9_26-l9_30)/(l9_32-l9_30),0.0,1.0)));
}
else
{
if (l9_26<l9_34)
{
l9_39=mix(l9_33,l9_35,float4(fast::clamp((l9_26-l9_32)/(l9_34-l9_32),0.0,1.0)));
}
else
{
if (l9_26<l9_36)
{
l9_39=mix(l9_35,l9_37,float4(fast::clamp((l9_26-l9_34)/(l9_36-l9_34),0.0,1.0)));
}
else
{
l9_39=mix(l9_37,l9_38,float4(fast::clamp((l9_26-l9_36)/(1.0-l9_36),0.0,1.0)));
}
}
}
}
}
bool l9_40=(*sc_set0.UserUniforms).PreviewEnabled==1;
bool l9_41;
if (l9_40)
{
l9_41=!PreviewInfo.Saved;
}
else
{
l9_41=l9_40;
...
if (l9_41)
{
l9_42=40==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_42=l9_41;
...
l9_43=(*sc_set0.UserUniforms).Port_Value_N005;
param_2=l9_43;
param_3=param_2;
}
Output_N3=param_3;
...
bool l9_47=(*sc_set0.UserUniforms).isProxyMode!=0;
if (l9_47)
{
...
float4 l9_48=fast::max(param_6,float4(0.0));
float4 param_7=l9_48;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
l9_51=fast::clamp(l9_50.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_51=fast::clamp(dot(l9_50.xyz,float3(l9_50.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_51=(1.0-dot(l9_50.xyz,float3(0.33333001)))*l9_50.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_51=(1.0-fast::clamp(dot(l9_50.xyz,float3(1.0)),0.0,1.0))*l9_50.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_51=fast::clamp(dot(l9_50.xyz,float3(1.0)),0.0,1.0)*l9_50.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_51=fast::clamp(dot(l9_50.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_51=dot(l9_50.xyz,float3(0.33333001))*l9_50.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_51=1.0-fast::clamp(dot(l9_50.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_52=l9_51;
float l9_53=l9_52;
float l9_54=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_53;
float3 l9_55=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_49.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_56=float4(l9_55.x,l9_55.y,l9_55.z,l9_54);
param_8=l9_56;
}
else
{
...
{
float4 l9_57=param_8;
float4 l9_58=float4(0.0);
float4 l9_59=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_60=out.FragColor0;
float4 l9_61=l9_60;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_61.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
float4 l9_62=l9_61;
l9_59=l9_62;
}
...
float2 l9_64=l9_63.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
float2 l9_65=l9_64;
...
int l9_69=l9_68;
int l9_70=l9_69;
float3 l9_71=float3(l9_65,0.0);
int l9_72=l9_67;
int l9_73=l9_70;
if (l9_72==1)
{
l9_71.y=((2.0*l9_71.y)+float(l9_73))-1.0;
}
float2 l9_74=l9_71.xy;
l9_66=l9_74;
}
else
{
...
float2 l9_90=l9_86;
int l9_91=sc_ScreenTextureLayout_tmp;
int l9_92=l9_87;
float l9_93=l9_88;
float2 l9_94=l9_90;
int l9_95=l9_91;
int l9_96=l9_92;
float3 l9_97=float3(0.0);
if (l9_95==0)
{
l9_97=float3(l9_94,0.0);
}
else
{
if (l9_95==1)
{
l9_97=float3(l9_94.x,(l9_94.y*0.5)+(0.5-(float(l9_96)*0.5)),0.0);
}
else
{
l9_97=float3(l9_94,float(l9_96));
}
}
float3 l9_98=l9_97;
float3 l9_99=l9_98;
float2 l9_100=l9_99.xy;
float l9_101=l9_93;
float4 l9_102=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_100,bias(l9_101));
...
{
l9_59.x+=(*sc_set0.UserUniforms)._sc_GetFramebufferColorInvalidUsageMarker;
}
float4 l9_107=l9_59;
float4 l9_108=l9_107;
float3 l9_109=l9_108.xyz;
float3 l9_110=l9_109;
float3 l9_111=l9_57.xyz;
float3 l9_112=definedBlend(l9_110,l9_111,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_58=float4(l9_112.x,l9_112.y,l9_112.z,l9_58.w);
float3 l9_113=mix(l9_109,l9_58.xyz,float3(l9_57.w));
l9_58=float4(l9_113.x,l9_113.y,l9_113.z,l9_58.w);
l9_58.w=1.0;
float4 l9_114=l9_58;
param_8=l9_114;
}
...
{
float4 l9_115=param_8;
float4 l9_116=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_116=float4(mix(float3(1.0),l9_115.xyz,float3(l9_115.w)),l9_115.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_117=l9_115.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_117=fast::clamp(l9_117,0.0,1.0);
}
l9_116=float4(l9_115.xyz*l9_117,l9_117);
}
else
{
l9_116=l9_115;
...
float4 l9_118=l9_116;
param_8=l9_118;
}
}
}
float4 l9_119=param_8;
FinalColor=l9_119;
if ((*sc_set0.UserUniforms).PreviewEnabled==1)
{
if (PreviewInfo.Saved)
...
{
l9_120=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_120=float4(0.0);
...
float4 l9_122=param_11;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_122.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_122;
return out;
}
} // FRAGMENT SHADER
