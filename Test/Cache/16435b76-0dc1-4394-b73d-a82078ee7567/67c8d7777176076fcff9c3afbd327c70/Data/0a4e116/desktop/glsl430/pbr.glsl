...
//sampler sampler sc_RayTracingGlobalIlluminationSmpSC 0:33
//sampler sampler sc_RayTracingHitCasterIdAndBarycentricSmpSC 0:34
//sampler sampler sc_RayTracingRayDirectionSmpSC 0:35
//sampler sampler sc_RayTracingReflectionsSmpSC 0:36
//sampler sampler sc_RayTracingShadowsSmpSC 0:37
...
//texture texture2D materialParamsTex 0:5:0:28
//texture texture2D normalTex 0:6:0:29
//texture texture2D sc_EnvmapDiffuse 0:7:0:30
//texture texture2D sc_EnvmapSpecular 0:8:0:31
//texture texture2D sc_OITAlpha0 0:9:0:32
//texture texture2D sc_OITAlpha1 0:10:0:32
//texture texture2D sc_OITDepthHigh0 0:11:0:32
//texture texture2D sc_OITDepthHigh1 0:12:0:32
//texture texture2D sc_OITDepthLow0 0:13:0:32
//texture texture2D sc_OITDepthLow1 0:14:0:32
//texture texture2D sc_OITFilteredDepthBoundsTexture 0:15:0:32
//texture texture2D sc_OITFrontDepthTexture 0:16:0:32
//texture texture2D sc_RayTracingGlobalIllumination 0:17:0:33
//texture utexture2D sc_RayTracingHitCasterIdAndBarycentric 0:18:0:34
//texture texture2D sc_RayTracingRayDirection 0:19:0:35
//texture texture2D sc_RayTracingReflections 0:20:0:36
//texture texture2D sc_RayTracingShadows 0:21:0:37
//texture texture2D sc_SSAOTexture 0:22:0:38
//texture texture2D sc_ScreenTexture 0:23:0:39
//texture texture2D sc_ShadowTexture 0:24:0:40
//texture texture2DArray baseTexArrSC 0:42:0:26
//texture texture2DArray intensityTextureArrSC 0:43:0:27
//texture texture2DArray materialParamsTexArrSC 0:44:0:28
//texture texture2DArray normalTexArrSC 0:45:0:29
//texture texture2DArray sc_EnvmapDiffuseArrSC 0:46:0:30
//texture texture2DArray sc_EnvmapSpecularArrSC 0:47:0:31
//texture texture2DArray sc_RayTracingGlobalIlluminationArrSC 0:48:0:33
//texture texture2DArray sc_RayTracingReflectionsArrSC 0:50:0:36
//texture texture2DArray sc_RayTracingShadowsArrSC 0:51:0:37
...
//spec_const bool sc_RayTracingGlobalIlluminationHasSwappedViews 83 0
//spec_const bool sc_RayTracingReflectionsHasSwappedViews 84 0
//spec_const bool sc_RayTracingShadowsHasSwappedViews 85 0
...
//spec_const bool sc_TAAEnabled 89 0
//spec_const bool sc_VertexBlending 90 0
//spec_const bool sc_VertexBlendingUseNormals 91 0
//spec_const bool sc_Voxelization 92 0
//spec_const int SC_DEVICE_CLASS 93 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_baseTex 94 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 95 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_materialParamsTex 96 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_normalTex 97 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTex 98 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 99 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_materialParamsTex 100 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_normalTex 101 -1
//spec_const int baseTexLayout 102 0
//spec_const int intensityTextureLayout 103 0
//spec_const int materialParamsTexLayout 104 0
//spec_const int normalTexLayout 105 0
//spec_const int sc_AmbientLightMode0 106 0
//spec_const int sc_AmbientLightMode1 107 0
//spec_const int sc_AmbientLightMode2 108 0
//spec_const int sc_AmbientLightMode_Constant 109 0
//spec_const int sc_AmbientLightMode_EnvironmentMap 110 0
//spec_const int sc_AmbientLightMode_FromCamera 111 0
//spec_const int sc_AmbientLightMode_SphericalHarmonics 112 0
//spec_const int sc_AmbientLightsCount 113 0
//spec_const int sc_DepthBufferMode 114 0
//spec_const int sc_DirectionalLightsCount 115 0
//spec_const int sc_EnvLightMode 116 0
//spec_const int sc_EnvmapDiffuseLayout 117 0
//spec_const int sc_EnvmapSpecularLayout 118 0
//spec_const int sc_LightEstimationSGCount 119 0
//spec_const int sc_PointLightsCount 120 0
//spec_const int sc_RayTracingGlobalIlluminationLayout 121 0
//spec_const int sc_RayTracingReflectionsLayout 122 0
//spec_const int sc_RayTracingShadowsLayout 123 0
//spec_const int sc_RenderingSpace 124 -1
//spec_const int sc_ScreenTextureLayout 125 0
//spec_const int sc_ShaderCacheConstant 126 0
//spec_const int sc_SkinBonesCount 127 0
//spec_const int sc_StereoRenderingMode 128 0
//spec_const int sc_StereoRendering_IsClipDistanceEnabled 129 0
//spec_const int sc_StereoViewID 130 0
//SG_REFLECTION_END
...
#endif
uvec3 l9_152=uvec3(round((varPos-sc_RayTracingOriginOffset)*sc_RayTracingOriginScale));
sc_RayTracingPositionAndMask=uvec4(l9_152.x,l9_152.y,l9_152.z,sc_RayTracingPositionAndMask.w);
sc_RayTracingPositionAndMask.w=sc_RayTracingReceiverMask;
vec3 l9_153=l9_150/vec3(dot(abs(l9_150),vec3(1.0)));
vec2 l9_154=vec2(clamp(-l9_153.z,0.0,1.0));
vec2 l9_155=l9_153.xy;
uint l9_156=packHalf2x16(l9_155+mix(-l9_154,l9_154,step(vec2(0.0),l9_155)));
uvec2 l9_157=uvec2(l9_156&65535u,l9_156>>16u);
sc_RayTracingNormalAndMore=uvec4(l9_157.x,l9_157.y,sc_RayTracingNormalAndMore.z,sc_RayTracingNormalAndMore.w);
sc_RayTracingNormalAndMore.z=0u;
sc_RayTracingNormalAndMore.w=uint(clamp(l9_101.y,0.0,1.0)*1000.0)|((sc_RayTracingReceiverId%32u)<<10u);
}
...
vec2 l9_13=l9_1-Port_Center_N016;
vec2 l9_14=(l9_13*vec2(uvScale))+Port_Center_N016;
vec4 l9_15;
#if (baseTexLayout==2)
{
...
#if (normalTexLayout==2)
{
bool l9_65=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTex)!=0));
float l9_66=l9_14.x;
sc_SoftwareWrapEarly(l9_66,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x);
float l9_67=l9_66;
float l9_68=l9_14.y;
sc_SoftwareWrapEarly(l9_68,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y);
float l9_69=l9_68;
vec2 l9_70;
float l9_71;
#if (SC_USE_UV_MIN_MAX_normalTex)
...
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_72=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x==3;
}
#else
{
l9_72=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0);
}
#endif
float l9_73=l9_67;
float l9_74=1.0;
sc_ClampUV(l9_73,normalTexUvMinMax.x,normalTexUvMinMax.z,l9_72,l9_74);
float l9_75=l9_73;
float l9_76=l9_74;
bool l9_77;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_77=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y==3;
}
#else
{
l9_77=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0);
}
#endif
float l9_78=l9_69;
float l9_79=l9_76;
sc_ClampUV(l9_78,normalTexUvMinMax.y,normalTexUvMinMax.w,l9_77,l9_79);
l9_71=l9_79;
...
#endif
vec2 l9_80=sc_TransformUV(l9_70,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform);
float l9_81=l9_80.x;
float l9_82=l9_71;
sc_SoftwareWrapLate(l9_81,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x,l9_65,l9_82);
float l9_83=l9_80.y;
float l9_84=l9_82;
sc_SoftwareWrapLate(l9_83,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y,l9_65,l9_84);
float l9_85=l9_84;
vec3 l9_86=sc_SamplingCoordsViewToGlobal(vec2(l9_81,l9_83),normalTexLayout,normalTexGetStereoViewIndex());
vec4 l9_87=texture(normalTexArrSC,l9_86,0.0);
vec4 l9_88;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_88=mix(normalTexBorderColor,l9_87,vec4(l9_85));
}
#else
{
l9_88=l9_87;
...
#else
{
bool l9_89=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTex)!=0));
float l9_90=l9_14.x;
sc_SoftwareWrapEarly(l9_90,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x);
float l9_91=l9_90;
float l9_92=l9_14.y;
sc_SoftwareWrapEarly(l9_92,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y);
float l9_93=l9_92;
vec2 l9_94;
float l9_95;
#if (SC_USE_UV_MIN_MAX_normalTex)
...
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_96=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x==3;
}
#else
{
...
float l9_97=l9_91;
float l9_98=1.0;
sc_ClampUV(l9_97,normalTexUvMinMax.x,normalTexUvMinMax.z,l9_96,l9_98);
float l9_99=l9_97;
float l9_100=l9_98;
bool l9_101;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_101=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y==3;
}
#else
{
l9_101=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0);
}
#endif
float l9_102=l9_93;
float l9_103=l9_100;
sc_ClampUV(l9_102,normalTexUvMinMax.y,normalTexUvMinMax.w,l9_101,l9_103);
l9_95=l9_103;
...
#endif
vec2 l9_104=sc_TransformUV(l9_94,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform);
float l9_105=l9_104.x;
float l9_106=l9_95;
sc_SoftwareWrapLate(l9_105,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x,l9_89,l9_106);
float l9_107=l9_104.y;
float l9_108=l9_106;
sc_SoftwareWrapLate(l9_107,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y,l9_89,l9_108);
float l9_109=l9_108;
vec3 l9_110=sc_SamplingCoordsViewToGlobal(vec2(l9_105,l9_107),normalTexLayout,normalTexGetStereoViewIndex());
vec4 l9_111=texture(normalTex,l9_110.xy,0.0);
vec4 l9_112;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_112=mix(normalTexBorderColor,l9_111,vec4(l9_109));
}
#else
{
l9_112=l9_111;
...
#if (materialParamsTexLayout==2)
{
bool l9_114=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0));
float l9_115=l9_14.x;
sc_SoftwareWrapEarly(l9_115,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x);
float l9_116=l9_115;
float l9_117=l9_14.y;
sc_SoftwareWrapEarly(l9_117,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y);
float l9_118=l9_117;
vec2 l9_119;
float l9_120;
#if (SC_USE_UV_MIN_MAX_materialParamsTex)
...
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_121=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x==3;
}
#else
{
l9_121=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_122=l9_116;
float l9_123=1.0;
sc_ClampUV(l9_122,materialParamsTexUvMinMax.x,materialParamsTexUvMinMax.z,l9_121,l9_123);
float l9_124=l9_122;
float l9_125=l9_123;
bool l9_126;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_126=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y==3;
}
#else
{
l9_126=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_127=l9_118;
float l9_128=l9_125;
sc_ClampUV(l9_127,materialParamsTexUvMinMax.y,materialParamsTexUvMinMax.w,l9_126,l9_128);
l9_120=l9_128;
...
#endif
vec2 l9_129=sc_TransformUV(l9_119,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform);
float l9_130=l9_129.x;
float l9_131=l9_120;
sc_SoftwareWrapLate(l9_130,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x,l9_114,l9_131);
float l9_132=l9_129.y;
float l9_133=l9_131;
sc_SoftwareWrapLate(l9_132,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y,l9_114,l9_133);
float l9_134=l9_133;
vec3 l9_135=sc_SamplingCoordsViewToGlobal(vec2(l9_130,l9_132),materialParamsTexLayout,materialParamsTexGetStereoViewIndex());
vec4 l9_136=texture(materialParamsTexArrSC,l9_135,0.0);
vec4 l9_137;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_137=mix(materialParamsTexBorderColor,l9_136,vec4(l9_134));
}
#else
{
l9_137=l9_136;
...
#else
{
bool l9_138=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0));
float l9_139=l9_14.x;
sc_SoftwareWrapEarly(l9_139,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x);
float l9_140=l9_139;
float l9_141=l9_14.y;
sc_SoftwareWrapEarly(l9_141,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y);
float l9_142=l9_141;
vec2 l9_143;
float l9_144;
#if (SC_USE_UV_MIN_MAX_materialParamsTex)
...
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_145=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x==3;
}
#else
{
l9_145=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_146=l9_140;
float l9_147=1.0;
sc_ClampUV(l9_146,materialParamsTexUvMinMax.x,materialParamsTexUvMinMax.z,l9_145,l9_147);
float l9_148=l9_146;
float l9_149=l9_147;
bool l9_150;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_150=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y==3;
}
#else
{
l9_150=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_151=l9_142;
float l9_152=l9_149;
sc_ClampUV(l9_151,materialParamsTexUvMinMax.y,materialParamsTexUvMinMax.w,l9_150,l9_152);
l9_144=l9_152;
...
#endif
vec2 l9_153=sc_TransformUV(l9_143,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform);
float l9_154=l9_153.x;
float l9_155=l9_144;
sc_SoftwareWrapLate(l9_154,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x,l9_138,l9_155);
float l9_156=l9_153.y;
float l9_157=l9_155;
sc_SoftwareWrapLate(l9_156,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y,l9_138,l9_157);
float l9_158=l9_157;
vec3 l9_159=sc_SamplingCoordsViewToGlobal(vec2(l9_154,l9_156),materialParamsTexLayout,materialParamsTexGetStereoViewIndex());
vec4 l9_160=texture(materialParamsTex,l9_159.xy,0.0);
vec4 l9_161;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_161=mix(materialParamsTexBorderColor,l9_160,vec4(l9_158));
}
#else
{
l9_161=l9_160;
...
#if (!sc_ProjectiveShadowsCaster)
{
l9_162=mat3(l9_4,l9_2,l9_3)*((l9_64.xyz*1.9921875)-vec3(1.0)).xyz;
}
#else
{
l9_162=vec3(0.0);
...
#endif
float l9_163=clamp(l9_15.w,0.0,1.0);
#if (sc_BlendMode_AlphaTest)
{
if (l9_163<alphaTestThreshold)
{
discard;
}
}
...
#if (ENABLE_STIPPLE_PATTERN_TEST)
{
if (l9_163<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
#endif
vec3 l9_164=max(l9_15.xyz,vec3(0.0));
vec4 l9_165;
#if (sc_ProjectiveShadowsCaster)
{
l9_165=vec4(l9_164,l9_163);
}
#else
{
l9_165=ngsCalculateLighting(l9_164,l9_163,l9_162,l9_5,l9_6,Port_Emissive_N006,clamp(l9_113.x,0.0,1.0),clamp(l9_113.y,0.0,1.0),clamp(vec3(l9_113.z),vec3(0.0),vec3(1.0)),Port_SpecularAO_N006);
}
#endif
vec4 l9_166=max(l9_165,vec4(0.0));
if (l9_0)
{
vec4 l9_167;
...
#endif
sc_writeFragData0Internal(max(l9_167,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_169;
#if (sc_ProjectiveShadowsCaster)
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_171=clamp(l9_166.w*2.0,0.0,1.0);
}
#else
{
float l9_172;
...
{
l9_172=clamp(dot(l9_166.xyz,vec3(l9_166.w)),0.0,1.0);
}
#else
{
float l9_173;
...
#if (sc_BlendMode_Multiply)
{
l9_174=(1.0-dot(l9_166.xyz,vec3(0.33333001)))*l9_166.w;
}
#else
{
float l9_175;
...
{
l9_175=(1.0-clamp(dot(l9_166.xyz,vec3(1.0)),0.0,1.0))*l9_166.w;
}
#else
{
float l9_176;
#if (sc_BlendMode_ColoredGlass)
{
l9_176=clamp(dot(l9_166.xyz,vec3(1.0)),0.0,1.0)*l9_166.w;
}
#else
{
float l9_177;
#if (sc_BlendMode_Add)
{
l9_177=clamp(dot(l9_166.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_178;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_178=clamp(dot(l9_166.xyz,vec3(1.0)),0.0,1.0)*l9_166.w;
}
#else
{
float l9_179;
...
{
l9_179=dot(l9_166.xyz,vec3(0.33333001))*l9_166.w;
}
#else
{
float l9_180;
#if (sc_BlendMode_Min)
{
l9_180=1.0-clamp(dot(l9_166.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_181;
#if (sc_BlendMode_Max)
{
l9_181=clamp(dot(l9_166.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_181=1.0;
...
#endif
l9_169=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_166.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_170);
}
#else
{
vec4 l9_182;
...
vec3 l9_185=mix(l9_184,definedBlend(l9_184,l9_166.xyz).xyz,vec3(l9_166.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_191=l9_166.w;
l9_190=vec4(mix(vec3(1.0),l9_166.xyz,vec3(l9_191)),l9_191);
}
#else
{
vec4 l9_192;
...
#endif
l9_192=vec4(l9_166.xyz*l9_194,l9_194);
}
#else
{
l9_192=l9_166;
...
vec4 l9_197=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_195,vec4(0.0)));
...
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_200).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_201=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_200).xy);
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_213).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_218==0)
{
l9_221=texture(sc_OITAlpha0,l9_213);
l9_220=texture(sc_OITDepthLow0,l9_213);
l9_219=texture(sc_OITDepthHigh0,l9_213);
}
else
{
l9_221=vec4(0.0);
...
if (l9_218==1)
{
l9_224=texture(sc_OITAlpha1,l9_213);
l9_223=texture(sc_OITDepthLow1,l9_213);
l9_222=texture(sc_OITDepthHigh1,l9_213);
}
else
{
l9_224=l9_221;
...
vec4 l9_239=texture(sc_OITFilteredDepthBoundsTexture,l9_213);
