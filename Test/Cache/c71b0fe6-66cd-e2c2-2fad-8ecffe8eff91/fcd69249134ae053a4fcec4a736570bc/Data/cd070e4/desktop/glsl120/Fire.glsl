...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N14 79 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 80 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N14 81 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 82 -1
//spec_const int Tweak_N14Layout 83 0
...
varColor=color;
vec3 l9_28=(sc_ModelMatrixInverse*vec4(varPos,1.0)).xyz;
vec3 l9_29=varNormal;
int l9_30=sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID);
vec4 param_5;
Node17_Switch(0.0,vec4(0.0),vec4(0.0),vec4(0.0),Port_Default_N017,param_5,ssGlobals(sc_Time.x,sc_Time.y,0.0,l9_28,varColor,texture3));
vec3 l9_31;
vec3 l9_32;
vec3 l9_33;
if (l9_25)
...
l9_33=varTangent.xyz;
l9_32=l9_29;
l9_31=(sc_ModelMatrix*vec4(((l9_28*vec3((float(l9_30)*Port_Input1_N009)+Port_Input1_N007,Port_Value2_N059,Port_Value3_N059))*param_5.xyz)*vec3(smoothstep(Port_Input0_N006,Port_Input1_N006,fire_scale)),1.0)).xyz;
}
varPos=l9_31;
...
#if (sc_RenderingSpace==3)
{
l9_35=sc_ProjectionMatrixInverseArray[sc_GetStereoViewIndex()]*l9_15;
}
#else
{
vec4 l9_36;
#if (sc_RenderingSpace==2)
{
l9_36=sc_ViewMatrixArray[sc_GetStereoViewIndex()]*l9_15;
}
#else
{
vec4 l9_37;
#if (sc_RenderingSpace==1)
{
l9_37=sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_15;
}
#else
{
l9_37=l9_15;
...
#if (sc_RenderingSpace==4)
{
l9_39=(sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_15)*vec4(1.0/sc_Camera.aspect,1.0,1.0,1.0);
}
#else
{
vec4 l9_40;
...
#if (sc_TAAEnabled)
{
vec2 l9_48=l9_44.xy+(sc_TAAJitterOffset*l9_44.w);
l9_47=vec4(l9_48.x,l9_48.y,l9_44.z,l9_44.w);
}
#else
{
l9_47=l9_44;
...
{
vec4 l9_50=l9_47;
l9_50.x=l9_47.x+(sc_UniformConstants.x*float(sc_ShaderCacheConstant));
l9_49=l9_50;
}
#else
{
...
float l9_62=l9_61;
vec3 l9_63=sc_SamplingCoordsViewToGlobal(vec2(l9_58,l9_60),Tweak_N14Layout,l9_41);
vec4 l9_64=texture2D(Tweak_N14,l9_63.xy,0.0);
vec4 l9_65;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N14)
{
...
#endif
vec3 l9_66=mix(l9_2.xyz,l9_34.xyz,vec3(1.0-l9_65.x));
vec4 l9_67=vec4(l9_66.x,l9_66.y,l9_66.z,vec4(0.0).w);
l9_67.w=Port_Value2_N001;
...
{
l9_70=clamp(Port_Value2_N001*2.0,0.0,1.0);
}
#else
{
float l9_71;
...
{
l9_71=clamp(dot(l9_67.xyz,vec3(Port_Value2_N001)),0.0,1.0);
}
#else
{
float l9_72;
...
{
l9_73=(1.0-dot(l9_67.xyz,vec3(0.33333001)))*Port_Value2_N001;
}
#else
{
float l9_74;
...
{
l9_74=(1.0-clamp(dot(l9_67.xyz,vec3(1.0)),0.0,1.0))*Port_Value2_N001;
}
#else
{
float l9_75;
...
{
l9_75=clamp(dot(l9_67.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N001;
}
#else
{
float l9_76;
#if (sc_BlendMode_Add)
{
l9_76=clamp(dot(l9_67.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_77;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_77=clamp(dot(l9_67.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N001;
}
#else
{
float l9_78;
...
{
l9_78=dot(l9_67.xyz,vec3(0.33333001))*Port_Value2_N001;
}
#else
{
float l9_79;
#if (sc_BlendMode_Min)
{
l9_79=1.0-clamp(dot(l9_67.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_80;
#if (sc_BlendMode_Max)
{
l9_80=clamp(dot(l9_67.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_80=1.0;
...
#endif
l9_68=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_67.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_69);
}
#else
{
vec4 l9_81;
...
#if (sc_FramebufferFetch)
{
vec4 l9_84=sc_readFragData0_Platform();
vec4 l9_85;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_86=l9_84;
l9_86.x=l9_84.x+_sc_framebufferFetchMarker;
l9_85=l9_86;
}
#else
{
...
#endif
l9_83=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_87,sc_ScreenTextureLayout,l9_88).xy,0.0);
}
#endif
vec4 l9_89;
...
{
vec4 l9_90=l9_83;
l9_90.x=l9_83.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_89=l9_90;
}
#else
{
...
#endif
vec3 l9_91=mix(l9_89.xyz,definedBlend(l9_89.xyz,l9_67.xyz).xyz,vec3(Port_Value2_N001));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_93=vec4(mix(vec3(1.0),l9_67.xyz,vec3(Port_Value2_N001)),Port_Value2_N001);
}
#else
{
vec4 l9_94;
...
{
l9_95=clamp(Port_Value2_N001,0.0,1.0);
}
#else
{
l9_95=Port_Value2_N001;
}
#endif
l9_94=vec4(l9_67.xyz*l9_95,l9_95);
}
#else
{
l9_94=l9_67;
...
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_103).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_104=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_103).xy);
...
if (l9_121==0)
{
l9_124=texture2D(sc_OITAlpha0,l9_116);
l9_123=texture2D(sc_OITDepthLow0,l9_116);
l9_122=texture2D(sc_OITDepthHigh0,l9_116);
}
else
{
l9_124=vec4(0.0);
...
if (l9_121==1)
{
l9_127=texture2D(sc_OITAlpha1,l9_116);
l9_126=texture2D(sc_OITDepthLow1,l9_116);
l9_125=texture2D(sc_OITDepthHigh1,l9_116);
}
else
{
l9_127=l9_124;
...
vec4 l9_142=texture2D(sc_OITFilteredDepthBoundsTexture,l9_116);
