...
//texture texture2D Tweak_N16 0:1:0:17
...
//}
//ubo int UserUniforms 0:26:4480 {
//float4 sc_Time 1376
...
//float heating 4128
//float3x3 Tweak_N16Transform 4192
//float4 Tweak_N16UvMinMax 4240
//float4 Tweak_N16BorderColor 4256
//float Port_Input1_N019 4272
//float Port_Input0_N003 4276
//float Port_Input1_N003 4280
//float2 Port_Input1_N002 4288
//float4 Port_Value0_N009 4304
//float Port_Position1_N009 4320
//float4 Port_Value1_N009 4336
//float4 Port_Value2_N009 4352
//float Port_Multiplier_N007 4368
//float Port_Input1_N026 4372
//float2 Port_Center_N014 4376
//float2 Port_Import_N030 4392
//float Port_Import_N029 4400
//float2 Port_Import_N023 4408
//float2 Port_Direction_N001 4416
//float Port_Speed_N001 4424
//float2 Port_Scale_N008 4432
//float2 Port_Center_N008 4440
//float Port_Input1_N024 4448
//float Port_Input1_N025 4452
//float Port_Input0_N018 4456
//float Port_Input1_N018 4460
//float Port_Input0_N035 4464
//float Port_Input1_N035 4468
//float Port_Input1_N037 4472
//}
...
//spec_const bool SC_USE_CLAMP_TO_BORDER_Tweak_N16 31 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_intensityTexture 32 0
//spec_const bool SC_USE_UV_MIN_MAX_Tweak_N16 33 0
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 34 0
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N16 35 0
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 36 0
//spec_const bool Tweak_N16HasSwappedViews 37 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N16 73 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 74 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N16 75 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 76 -1
//spec_const int Tweak_N16Layout 77 0
...
constant bool SC_USE_UV_MIN_MAX_Tweak_N16 [[function_constant(33)]];
...
constant bool SC_USE_UV_TRANSFORM_Tweak_N16 [[function_constant(35)]];
...
constant bool Tweak_N16HasSwappedViews [[function_constant(37)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N16 [[function_constant(73)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N16 [[function_constant(75)]];
...
constant int Tweak_N16Layout [[function_constant(77)]];
...
float param_1=(*sc_set0.UserUniforms).heating;
Output_N13=param_1;
float Output_N19=0.0;
Output_N19=Output_N13*(*sc_set0.UserUniforms).Port_Input1_N019;
float3 Output_N12=float3(0.0);
Output_N12=Position_N10*float3(Output_N19);
float3 VectorOut_N11=float3(0.0);
VectorOut_N11=((*sc_set0.UserUniforms).sc_ModelMatrix*float4(Output_N12,1.0)).xyz;
...
int l9_131=l9_130;
l9_129=((*sc_set0.UserUniforms).sc_ModelViewMatrixArray[l9_131]*param_2.position)*float4(1.0/(*sc_set0.UserUniforms).sc_Camera.aspect,1.0,1.0,1.0);
}
else
{
if (sc_RenderingSpace_tmp==2)
...
{
float4 l9_136=param_2.position;
...
float Output_N2=0.0;
Output_N2=distance(UVCoord_N17,(*sc_set0.UserUniforms).Port_Input1_N002);
float Output_N3=0.0;
Output_N3=smoothstep((*sc_set0.UserUniforms).Port_Input0_N003,(*sc_set0.UserUniforms).Port_Input1_N003,Output_N2);
float4 Value_N9=float4(0.0);
float param=Output_N3;
float4 param_1=(*sc_set0.UserUniforms).Port_Value0_N009;
float param_2=(*sc_set0.UserUniforms).Port_Position1_N009;
float4 param_3=(*sc_set0.UserUniforms).Port_Value1_N009;
float4 param_4=(*sc_set0.UserUniforms).Port_Value2_N009;
...
if (l9_1)
{
l9_2=9==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_2=l9_1;
...
Output_N26=Time_N7*(*sc_set0.UserUniforms).Port_Input1_N026;
float2 CoordsOut_N14=float2(0.0);
float2 param_6=UVCoord_N17;
float param_7=Output_N26;
float2 param_8=(*sc_set0.UserUniforms).Port_Center_N014;
float l9_3=sin(radians(param_7));
float l9_4=cos(radians(param_7));
float2 param_9=param_6-param_8;
param_9=float2(dot(float2(l9_4,l9_3),param_9),dot(float2(-l9_3,l9_4),param_9))+param_8;
...
Value_N23=(*sc_set0.UserUniforms).Port_Import_N023;
...
N32_Center=param_14;
float2 l9_5=N32_UV;
float2 l9_6=N32_Scale*2.0;
float2 l9_7=l9_5;
float2 l9_8=l9_6;
float l9_9=N32_RotationOffset;
float2 l9_10=N32_Center;
float l9_11=sin(radians(l9_9));
float l9_12=cos(radians(l9_9));
float2 l9_13=l9_7-l9_10;
float2 l9_14=(float2(dot(float2(l9_12,l9_11),l9_13),dot(float2(-l9_11,l9_12),l9_13))*l9_8)+l9_10;
l9_5=l9_14;
l9_5-=N32_Center;
float l9_15=(l9_5.x*l9_5.x)+(l9_5.y*l9_5.y);
float l9_16;
if (l9_15<=0.0)
{
l9_16=0.0;
...
float l9_25=3.1415927;
float l9_26=3.1415927;
l9_23=0.0+(((l9_23-(-l9_24))*1.0)/((l9_25-(-l9_26))+1e-06));
}
else
{
...
l9_23=1.0+(((l9_23-(-l9_27))*(-1.0))/((l9_28-(-l9_29))+1e-06));
}
N32_PolarCoordinates=float2(l9_18,l9_23);
...
CoordsOut_N1=Export_N33+((*sc_set0.UserUniforms).Port_Direction_N001*(Globals.gTimeElapsed*(*sc_set0.UserUniforms).Port_Speed_N001));
float2 CoordsOut_N8=float2(0.0);
CoordsOut_N8=((CoordsOut_N1-(*sc_set0.UserUniforms).Port_Center_N008)*(*sc_set0.UserUniforms).Port_Scale_N008)+(*sc_set0.UserUniforms).Port_Center_N008;
...
float3x3 param_20=(*sc_set0.UserUniforms).Tweak_N16Transform;
...
float4 param_23=(*sc_set0.UserUniforms).Tweak_N16UvMinMax;
bool param_24=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N16_tmp)!=0);
float4 param_25=(*sc_set0.UserUniforms).Tweak_N16BorderColor;
float param_26=0.0;
bool l9_36=param_24&&(!param_22);
float l9_37=1.0;
float l9_38=param_18.x;
int l9_39=param_21.x;
if (l9_39==1)
{
l9_38=fract(l9_38);
}
...
param_18.x=l9_38;
float l9_43=param_18.y;
int l9_44=param_21.y;
if (l9_44==1)
{
l9_43=fract(l9_43);
}
...
float l9_50=param_18.x;
float l9_51=param_23.x;
float l9_52=param_23.z;
bool l9_53=l9_49;
float l9_54=l9_37;
...
float l9_59=param_18.y;
float l9_60=param_23.y;
float l9_61=param_23.w;
bool l9_62=l9_58;
float l9_63=l9_37;
...
float2 l9_66=param_18;
bool l9_67=param_19;
float3x3 l9_68=param_20;
if (l9_67)
{
...
float2 l9_71=l9_70;
param_18=l9_71;
float l9_72=param_18.x;
int l9_73=param_21.x;
bool l9_74=l9_36;
float l9_75=l9_37;
if ((l9_73==0)||(l9_73==3))
{
...
param_18.x=l9_72;
l9_37=l9_75;
float l9_83=param_18.y;
int l9_84=param_21.y;
bool l9_85=l9_36;
float l9_86=l9_37;
if ((l9_84==0)||(l9_84==3))
{
...
param_18.y=l9_83;
l9_37=l9_86;
float2 l9_94=param_18;
int l9_95=param_16;
int l9_96=param_17;
float l9_97=param_26;
float2 l9_98=l9_94;
int l9_99=l9_95;
int l9_100=l9_96;
...
float l9_105=l9_97;
float4 l9_106=sc_set0.Tweak_N16.sample(sc_set0.Tweak_N16SmpSC,l9_104,bias(l9_105));
float4 l9_107=l9_106;
float4 l9_108=l9_107;
if (param_24)
{
l9_108=mix(param_25,l9_108,float4(l9_37));
}
...
{
l9_110=pow(Output_N21,(*sc_set0.UserUniforms).Port_Input1_N024);
}
Output_N24=l9_110;
...
{
l9_111=pow(Output_N20,(*sc_set0.UserUniforms).Port_Input1_N025);
}
Output_N25=l9_111;
float Output_N13=0.0;
float param_27=(*sc_set0.UserUniforms).heating;
Output_N13=param_27;
float Output_N18=0.0;
Output_N18=smoothstep((*sc_set0.UserUniforms).Port_Input0_N018,(*sc_set0.UserUniforms).Port_Input1_N018,Output_N13);
float Output_N35=0.0;
Output_N35=smoothstep((*sc_set0.UserUniforms).Port_Input0_N035,(*sc_set0.UserUniforms).Port_Input1_N035,Output_N13);
...
Output_N37=Value_N0*float4((*sc_set0.UserUniforms).Port_Input1_N037);
...
float2 l9_113=floor(mod(l9_112.xy,float2(4.0)));
float l9_114=(mod(dot(l9_113,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_28<l9_114)
{
discard_fragment();
}
...
{
l9_117=fast::clamp(l9_116.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_117=fast::clamp(dot(l9_116.xyz,float3(l9_116.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_117=(1.0-dot(l9_116.xyz,float3(0.33333001)))*l9_116.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_117=(1.0-fast::clamp(dot(l9_116.xyz,float3(1.0)),0.0,1.0))*l9_116.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_117=fast::clamp(dot(l9_116.xyz,float3(1.0)),0.0,1.0)*l9_116.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_117=fast::clamp(dot(l9_116.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_117=dot(l9_116.xyz,float3(0.33333001))*l9_116.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_117=1.0-fast::clamp(dot(l9_116.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_118=l9_117;
float l9_119=l9_118;
float l9_120=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_119;
float3 l9_121=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_115.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_122=float4(l9_121.x,l9_121.y,l9_121.z,l9_120);
param_29=l9_122;
}
else
{
...
{
float4 l9_123=param_29;
float4 l9_124=float4(0.0);
float4 l9_125=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_126=out.FragColor0;
float4 l9_127=l9_126;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_127.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
...
float2 l9_130=l9_129.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_135=l9_134;
int l9_136=l9_135;
float3 l9_137=float3(l9_131,0.0);
int l9_138=l9_133;
int l9_139=l9_136;
if (l9_138==1)
{
l9_137.y=((2.0*l9_137.y)+float(l9_139))-1.0;
}
float2 l9_140=l9_137.xy;
l9_132=l9_140;
}
else
{
...
int l9_157=sc_ScreenTextureLayout_tmp;
int l9_158=l9_153;
float l9_159=l9_154;
...
float l9_167=l9_159;
float4 l9_168=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_166,bias(l9_167));
...
{
l9_125.x+=(*sc_set0.UserUniforms)._sc_GetFramebufferColorInvalidUsageMarker;
}
float4 l9_173=l9_125;
float4 l9_174=l9_173;
float3 l9_175=l9_174.xyz;
float3 l9_176=l9_175;
float3 l9_177=l9_123.xyz;
...
l9_124=float4(l9_178.x,l9_178.y,l9_178.z,l9_124.w);
float3 l9_179=mix(l9_175,l9_124.xyz,float3(l9_123.w));
l9_124=float4(l9_179.x,l9_179.y,l9_179.z,l9_124.w);
l9_124.w=1.0;
float4 l9_180=l9_124;
param_29=l9_180;
}
else
{
float4 l9_181=param_29;
float4 l9_182=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_182=float4(mix(float3(1.0),l9_181.xyz,float3(l9_181.w)),l9_181.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_183=l9_181.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_183=fast::clamp(l9_183,0.0,1.0);
}
l9_182=float4(l9_181.xyz*l9_183,l9_183);
}
else
{
l9_182=l9_181;
...
float4 l9_184=l9_182;
param_29=l9_184;
}
}
}
float4 l9_185=param_29;
FinalColor=l9_185;
if ((*sc_set0.UserUniforms).PreviewEnabled==1)
{
if (PreviewInfo.Saved)
...
{
l9_186=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_186=float4(0.0);
...
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_188.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_188;
return out;
}
} // FRAGMENT SHADER
