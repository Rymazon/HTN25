...
//sampler sampler fingertipSmpSC 0:23
//sampler sampler handGlowTexSmpSC 0:24
...
//texture texture2D fingertip 0:4:0:23
//texture texture2D handGlowTex 0:5:0:24
...
//float4 indexGlowColor 4384
//float indexBrightness 4400
//float3x3 fingertipTransform 4464
//float4 fingertipUvMinMax 4512
//float4 fingertipBorderColor 4528
//float3x3 handGlowTexTransform 4592
//float4 handGlowTexUvMinMax 4640
//float4 handGlowTexBorderColor 4656
//float blend_coef 4672
//float4 thumbGlowColor 4688
//float thumbBrightness 4704
//float Port_Input0_N003 4708
//float Port_Input0_N011 4712
//float depthRef 4720
//}
...
//spec_const bool SC_USE_CLAMP_TO_BORDER_fingertip 31 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_handGlowTex 32 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_intensityTexture 33 0
//spec_const bool SC_USE_UV_MIN_MAX_fingertip 34 0
//spec_const bool SC_USE_UV_MIN_MAX_handGlowTex 35 0
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 36 0
//spec_const bool SC_USE_UV_TRANSFORM_fingertip 37 0
//spec_const bool SC_USE_UV_TRANSFORM_handGlowTex 38 0
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 39 0
//spec_const bool UseViewSpaceDepthVariant 40 1
//spec_const bool fingertipHasSwappedViews 41 0
//spec_const bool handGlowTexHasSwappedViews 42 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_fingertip 75 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_handGlowTex 76 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 77 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_fingertip 78 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_handGlowTex 79 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 80 -1
//spec_const int fingertipLayout 81 0
//spec_const int handGlowTexLayout 82 0
...
constant bool SC_USE_CLAMP_TO_BORDER_fingertip [[function_constant(31)]];
constant bool SC_USE_CLAMP_TO_BORDER_fingertip_tmp = is_function_constant_defined(SC_USE_CLAMP_TO_BORDER_fingertip) ? SC_USE_CLAMP_TO_BORDER_fingertip : false;
constant bool SC_USE_CLAMP_TO_BORDER_handGlowTex [[function_constant(32)]];
...
constant bool SC_USE_UV_MIN_MAX_fingertip [[function_constant(34)]];
constant bool SC_USE_UV_MIN_MAX_fingertip_tmp = is_function_constant_defined(SC_USE_UV_MIN_MAX_fingertip) ? SC_USE_UV_MIN_MAX_fingertip : false;
constant bool SC_USE_UV_MIN_MAX_handGlowTex [[function_constant(35)]];
...
constant bool SC_USE_UV_TRANSFORM_fingertip [[function_constant(37)]];
constant bool SC_USE_UV_TRANSFORM_fingertip_tmp = is_function_constant_defined(SC_USE_UV_TRANSFORM_fingertip) ? SC_USE_UV_TRANSFORM_fingertip : false;
constant bool SC_USE_UV_TRANSFORM_handGlowTex [[function_constant(38)]];
...
constant bool fingertipHasSwappedViews [[function_constant(41)]];
constant bool fingertipHasSwappedViews_tmp = is_function_constant_defined(fingertipHasSwappedViews) ? fingertipHasSwappedViews : false;
constant bool handGlowTexHasSwappedViews [[function_constant(42)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_fingertip [[function_constant(75)]];
constant int SC_SOFTWARE_WRAP_MODE_U_fingertip_tmp = is_function_constant_defined(SC_SOFTWARE_WRAP_MODE_U_fingertip) ? SC_SOFTWARE_WRAP_MODE_U_fingertip : -1;
constant int SC_SOFTWARE_WRAP_MODE_U_handGlowTex [[function_constant(76)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_fingertip [[function_constant(78)]];
constant int SC_SOFTWARE_WRAP_MODE_V_fingertip_tmp = is_function_constant_defined(SC_SOFTWARE_WRAP_MODE_V_fingertip) ? SC_SOFTWARE_WRAP_MODE_V_fingertip : -1;
constant int SC_SOFTWARE_WRAP_MODE_V_handGlowTex [[function_constant(79)]];
...
constant int fingertipLayout [[function_constant(81)]];
constant int fingertipLayout_tmp = is_function_constant_defined(fingertipLayout) ? fingertipLayout : 0;
constant int handGlowTexLayout [[function_constant(82)]];
...
float4 fingertipSize;
float4 fingertipDims;
float4 fingertipView;
float3x3 fingertipTransform;
float4 fingertipUvMinMax;
float4 fingertipBorderColor;
...
texture2d<float> fingertip [[id(4)]];
texture2d<float> handGlowTex [[id(5)]];
...
sampler fingertipSmpSC [[id(23)]];
sampler handGlowTexSmpSC [[id(24)]];
...
float4 param_1=(*sc_set0.UserUniforms).indexGlowColor;
Output_N6=param_1;
float Value1_N9=0.0;
float Value2_N9=0.0;
float Value3_N9=0.0;
float3 param_2=Output_N6.xyz;
...
Value3_N9=param_5;
float Output_N5=0.0;
float param_6=(*sc_set0.UserUniforms).indexBrightness;
Output_N5=param_6;
float2 UVCoord_N18=float2(0.0);
UVCoord_N18=Globals.Surface_UVCoord0;
float4 Color_N19=float4(0.0);
int l9_1;
if ((int(fingertipHasSwappedViews_tmp)!=0))
{
int l9_2=0;
if (sc_StereoRenderingMode_tmp==0)
{
...
int l9_6=l9_1;
int param_7=fingertipLayout_tmp;
int param_8=l9_6;
float2 param_9=UVCoord_N18;
bool param_10=(int(SC_USE_UV_TRANSFORM_fingertip_tmp)!=0);
float3x3 param_11=(*sc_set0.UserUniforms).fingertipTransform;
int2 param_12=int2(SC_SOFTWARE_WRAP_MODE_U_fingertip_tmp,SC_SOFTWARE_WRAP_MODE_V_fingertip_tmp);
bool param_13=(int(SC_USE_UV_MIN_MAX_fingertip_tmp)!=0);
float4 param_14=(*sc_set0.UserUniforms).fingertipUvMinMax;
bool param_15=(int(SC_USE_CLAMP_TO_BORDER_fingertip_tmp)!=0);
float4 param_16=(*sc_set0.UserUniforms).fingertipBorderColor;
float param_17=0.0;
bool l9_7=param_15&&(!param_13);
float l9_8=1.0;
float l9_9=param_9.x;
int l9_10=param_12.x;
if (l9_10==1)
{
l9_9=fract(l9_9);
}
...
param_9.x=l9_9;
float l9_14=param_9.y;
int l9_15=param_12.y;
if (l9_15==1)
{
l9_14=fract(l9_14);
}
...
float l9_21=param_9.x;
float l9_22=param_14.x;
float l9_23=param_14.z;
bool l9_24=l9_20;
float l9_25=l9_8;
...
float l9_30=param_9.y;
float l9_31=param_14.y;
float l9_32=param_14.w;
bool l9_33=l9_29;
float l9_34=l9_8;
...
float2 l9_37=param_9;
bool l9_38=param_10;
float3x3 l9_39=param_11;
if (l9_38)
{
...
float2 l9_40=l9_37;
param_9=l9_40;
float l9_41=param_9.x;
int l9_42=param_12.x;
bool l9_43=l9_7;
float l9_44=l9_8;
if ((l9_42==0)||(l9_42==3))
{
...
param_9.x=l9_41;
l9_8=l9_44;
float l9_52=param_9.y;
int l9_53=param_12.y;
bool l9_54=l9_7;
float l9_55=l9_8;
if ((l9_53==0)||(l9_53==3))
{
...
param_9.y=l9_52;
l9_8=l9_55;
float2 l9_63=param_9;
int l9_64=param_7;
int l9_65=param_8;
float l9_66=param_17;
float2 l9_67=l9_63;
int l9_68=l9_64;
int l9_69=l9_65;
...
float3 l9_71=l9_70;
float3 l9_72=l9_71;
float4 l9_73=sc_set0.fingertip.sample(sc_set0.fingertipSmpSC,l9_72.xy,bias(l9_66));
float4 l9_74=l9_73;
if (param_15)
{
l9_74=mix(param_16,l9_74,float4(l9_8));
}
float4 l9_75=l9_74;
Color_N19=l9_75;
...
int l9_81=l9_76;
int param_18=handGlowTexLayout_tmp;
int param_19=l9_81;
float2 param_20=UVCoord_N0;
bool param_21=(int(SC_USE_UV_TRANSFORM_handGlowTex_tmp)!=0);
float3x3 param_22=(*sc_set0.UserUniforms).handGlowTexTransform;
int2 param_23=int2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex_tmp,SC_SOFTWARE_WRAP_MODE_V_handGlowTex_tmp);
bool param_24=(int(SC_USE_UV_MIN_MAX_handGlowTex_tmp)!=0);
float4 param_25=(*sc_set0.UserUniforms).handGlowTexUvMinMax;
bool param_26=(int(SC_USE_CLAMP_TO_BORDER_handGlowTex_tmp)!=0);
float4 param_27=(*sc_set0.UserUniforms).handGlowTexBorderColor;
float param_28=0.0;
bool l9_82=param_26&&(!param_24);
float l9_83=1.0;
float l9_84=param_20.x;
int l9_85=param_23.x;
if (l9_85==1)
{
l9_84=fract(l9_84);
}
...
float l9_96=param_20.x;
float l9_97=param_25.x;
float l9_98=param_25.z;
bool l9_99=l9_95;
float l9_100=l9_83;
...
float l9_105=param_20.y;
float l9_106=param_25.y;
float l9_107=param_25.w;
bool l9_108=l9_104;
float l9_109=l9_83;
...
float2 l9_112=param_20;
bool l9_113=param_21;
float3x3 l9_114=param_22;
if (l9_113)
{
...
param_20.x=l9_116;
l9_83=l9_119;
float l9_127=param_20.y;
int l9_128=param_23.y;
bool l9_129=l9_82;
float l9_130=l9_83;
...
param_20.y=l9_127;
l9_83=l9_130;
float2 l9_138=param_20;
int l9_139=param_18;
int l9_140=param_19;
float l9_141=param_28;
...
float4 l9_148=sc_set0.handGlowTex.sample(sc_set0.handGlowTexSmpSC,l9_147.xy,bias(l9_141));
float4 l9_149=l9_148;
if (param_26)
{
l9_149=mix(param_27,l9_149,float4(l9_83));
}
float4 l9_150=l9_149;
Color_N1=l9_150;
float Output_N21=0.0;
float param_29=(*sc_set0.UserUniforms).blend_coef;
Output_N21=param_29;
float4 Output_N20=float4(0.0);
Output_N20=mix(Color_N19,Color_N1,float4(Output_N21));
float Output_N8=0.0;
Output_N8=Output_N20.y;
float Output_N3=0.0;
...
float4 param_30=(*sc_set0.UserUniforms).thumbGlowColor;
Output_N15=param_30;
float Value1_N16=0.0;
float Value2_N16=0.0;
float Value3_N16=0.0;
float3 param_31=Output_N15.xyz;
float param_32=param_31.x;
float param_33=param_31.y;
float param_34=param_31.z;
Value1_N16=param_32;
Value2_N16=param_33;
Value3_N16=param_34;
float Output_N10=0.0;
float param_35=(*sc_set0.UserUniforms).thumbBrightness;
Output_N10=param_35;
float Output_N12=0.0;
Output_N12=Output_N20.x;
...
float4 param_37=Value_N7;
float4 param_38=Value_N17;
float4 l9_151=param_37;
float4 l9_152=param_38;
float3 l9_153=l9_151.xyz*l9_151.w;
l9_151=float4(l9_153.x,l9_153.y,l9_153.z,l9_151.w);
float4 param_36=l9_151+(l9_152*(1.0-l9_151.w));
Output_N14=param_36;
FinalColor=Output_N14;
float param_39=FinalColor.w;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (param_39<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
float2 l9_155=floor(mod(l9_154.xy,float2(4.0)));
float l9_156=(mod(dot(l9_155,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_39<l9_156)
{
discard_fragment();
}
...
float4 l9_157=fast::max(param_40,float4(0.0));
float4 param_41=l9_157;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
FinalColor=sc_OutputMotionVectorsIfNeeded(param_43,param_44,in.varStereoViewID,(*sc_set0.UserUniforms));
float4 param_45=FinalColor;
float4 l9_225=param_45;
if (sc_ShaderCacheConstant_tmp!=0)
{
