...
//texture texture2D mainTex 0:5:0:23
...
//float3x3 mainTexTransform 4432
//float4 mainTexUvMinMax 4480
//float4 mainTexBorderColor 4496
//float4 glowColor 4512
//float brightness 4528
//float pinchBrightness 4532
//float pokeBrightness 4536
//float depthRef 4540
//}
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_mainTex 72 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 73 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_mainTex 74 -1
//spec_const int intensityTextureLayout 75 0
//spec_const int mainTexLayout 76 0
...
constant bool SC_USE_UV_MIN_MAX_mainTex [[function_constant(34)]];
...
constant bool SC_USE_UV_TRANSFORM_mainTex [[function_constant(36)]];
...
constant bool mainTexHasSwappedViews [[function_constant(39)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_mainTex [[function_constant(72)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_mainTex [[function_constant(74)]];
...
constant int mainTexLayout [[function_constant(76)]];
...
float3x3 param_5=(*sc_set0.UserUniforms).mainTexTransform;
...
float4 param_8=(*sc_set0.UserUniforms).mainTexUvMinMax;
bool param_9=(int(SC_USE_CLAMP_TO_BORDER_mainTex_tmp)!=0);
float4 param_10=(*sc_set0.UserUniforms).mainTexBorderColor;
float param_11=0.0;
...
float3 l9_71=l9_70;
float3 l9_72=l9_71;
float4 l9_73=sc_set0.mainTex.sample(sc_set0.mainTexSmpSC,l9_72.xy,bias(l9_66));
float4 l9_74=l9_73;
if (param_9)
{
...
float4 param_12=(*sc_set0.UserUniforms).glowColor;
Output_N3=param_12;
...
float param_13=(*sc_set0.UserUniforms).brightness;
Output_N12=param_13;
float Output_N13=0.0;
float param_14=(*sc_set0.UserUniforms).pinchBrightness;
Output_N13=param_14;
float Output_N14=0.0;
float param_15=(*sc_set0.UserUniforms).pokeBrightness;
Output_N14=param_15;
...
float3 l9_134=mix(l9_130,l9_89.xyz,float3(l9_88.w));
l9_89=float4(l9_134.x,l9_134.y,l9_134.z,l9_89.w);
l9_89.w=1.0;
float4 l9_135=l9_89;
param_19=l9_135;
}
