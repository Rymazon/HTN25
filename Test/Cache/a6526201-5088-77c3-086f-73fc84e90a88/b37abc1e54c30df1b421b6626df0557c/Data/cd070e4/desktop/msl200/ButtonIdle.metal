...
//float2 Port_Input1_N009 4568
//float2 Port_Input2_N009 4576
//float4 Port_Value0_N007 4592
//float Port_Position1_N007 4608
//float4 Port_Value1_N007 4624
//float Port_Position2_N007 4640
//float4 Port_Value2_N007 4656
//float4 Port_Value3_N007 4672
//float Port_Value0_N018 4688
//float Port_Position1_N018 4692
//float Port_Value1_N018 4696
//float Port_Position2_N018 4700
//float Port_Value2_N018 4704
//float Port_Position3_N018 4708
//float Port_Value3_N018 4712
//float Port_Value4_N018 4716
//float2 Port_Scale_N002 4720
//float2 Port_Center_N002 4728
//float Port_Input2_N003 4736
//float depthRef 4740
//}
...
float4 param_14=(*sc_set0.UserUniforms).Port_Value0_N007;
float param_15=(*sc_set0.UserUniforms).Port_Position1_N007;
float4 param_16=(*sc_set0.UserUniforms).Port_Value1_N007;
float param_17=(*sc_set0.UserUniforms).Port_Position2_N007;
float4 param_18=(*sc_set0.UserUniforms).Port_Value2_N007;
float4 param_19=(*sc_set0.UserUniforms).Port_Value3_N007;
...
bool l9_90=(*sc_set0.UserUniforms).PreviewEnabled==1;
bool l9_91;
if (l9_90)
{
l9_91=!PreviewInfo.Saved;
}
else
{
l9_91=l9_90;
...
if (l9_91)
{
l9_92=7==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_92=l9_91;
...
float param_22=(*sc_set0.UserUniforms).Port_Value0_N018;
float param_23=(*sc_set0.UserUniforms).Port_Position1_N018;
float param_24=(*sc_set0.UserUniforms).Port_Value1_N018;
float param_25=(*sc_set0.UserUniforms).Port_Position2_N018;
float param_26=(*sc_set0.UserUniforms).Port_Value2_N018;
float param_27=(*sc_set0.UserUniforms).Port_Position3_N018;
float param_28=(*sc_set0.UserUniforms).Port_Value3_N018;
float param_29=(*sc_set0.UserUniforms).Port_Value4_N018;
...
float param_41=0.0;
bool l9_99=param_39&&(!param_37);
float l9_100=1.0;
float l9_101=param_33.x;
int l9_102=param_36.x;
if (l9_102==1)
{
l9_101=fract(l9_101);
}
...
param_33.x=l9_101;
float l9_106=param_33.y;
int l9_107=param_36.y;
if (l9_107==1)
{
l9_106=fract(l9_106);
}
...
float l9_113=param_33.x;
float l9_114=param_38.x;
float l9_115=param_38.z;
bool l9_116=l9_112;
float l9_117=l9_100;
...
float l9_123=param_38.y;
float l9_124=param_38.w;
bool l9_125=l9_121;
float l9_126=l9_100;
...
float2 l9_129=param_33;
bool l9_130=param_34;
float3x3 l9_131=param_35;
if (l9_130)
{
...
param_33=l9_134;
float l9_135=param_33.x;
int l9_136=param_36.x;
bool l9_137=l9_99;
float l9_138=l9_100;
...
param_33.x=l9_135;
l9_100=l9_138;
float l9_146=param_33.y;
int l9_147=param_36.y;
bool l9_148=l9_99;
float l9_149=l9_100;
...
param_33.y=l9_146;
l9_100=l9_149;
float2 l9_157=param_33;
int l9_158=param_31;
int l9_159=param_32;
float l9_160=param_41;
...
float l9_168=l9_160;
float4 l9_169=sc_set0.icon.sample(sc_set0.iconSmpSC,l9_167,bias(l9_168));
float4 l9_170=l9_169;
float4 l9_171=l9_170;
if (param_39)
{
l9_171=mix(param_40,l9_171,float4(l9_100));
}
...
float param_42=1.0;
float param_43=1.0;
float param_44=(*sc_set0.UserUniforms).Port_Input2_N003;
ssGlobals param_46=Globals;
float l9_173=0.0;
float l9_174=float((*sc_set0.UserUniforms).iconEnabled!=0);
l9_173=l9_174;
param_42=l9_173;
float param_45;
if ((param_42*1.0)!=0.0)
...
l9_175=param_46.Surface_UVCoord1;
float2 l9_176=float2(0.0);
l9_176=((l9_175-(*sc_set0.UserUniforms).Port_Center_N002)*(*sc_set0.UserUniforms).Port_Scale_N002)+(*sc_set0.UserUniforms).Port_Center_N002;
...
int l9_183=l9_178;
int l9_184=iconLayout_tmp;
int l9_185=l9_183;
float2 l9_186=l9_176;
bool l9_187=(int(SC_USE_UV_TRANSFORM_icon_tmp)!=0);
float3x3 l9_188=(*sc_set0.UserUniforms).iconTransform;
int2 l9_189=int2(SC_SOFTWARE_WRAP_MODE_U_icon_tmp,SC_SOFTWARE_WRAP_MODE_V_icon_tmp);
bool l9_190=(int(SC_USE_UV_MIN_MAX_icon_tmp)!=0);
float4 l9_191=(*sc_set0.UserUniforms).iconUvMinMax;
bool l9_192=(int(SC_USE_CLAMP_TO_BORDER_icon_tmp)!=0);
float4 l9_193=(*sc_set0.UserUniforms).iconBorderColor;
float l9_194=0.0;
...
float l9_264=l9_256;
float4 l9_265=sc_set0.icon.sample(sc_set0.iconSmpSC,l9_263,bias(l9_264));
...
l9_177=l9_268;
float l9_269=0.0;
float4 l9_270=l9_177;
float l9_271=l9_270.w;
l9_269=l9_271;
param_43=l9_269;
param_45=param_43;
}
...
{
float4 l9_272=gl_FragCoord;
float2 l9_273=floor(mod(l9_272.xy,float2(4.0)));
float l9_274=(mod(dot(l9_273,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_47<l9_274)
{
discard_fragment();
}
...
float4 l9_276=fast::max(param_48,float4(0.0));
float4 param_49=l9_276;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
l9_279=fast::clamp(l9_278.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_279=fast::clamp(dot(l9_278.xyz,float3(l9_278.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_279=(1.0-dot(l9_278.xyz,float3(0.33333001)))*l9_278.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_279=(1.0-fast::clamp(dot(l9_278.xyz,float3(1.0)),0.0,1.0))*l9_278.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_279=fast::clamp(dot(l9_278.xyz,float3(1.0)),0.0,1.0)*l9_278.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_279=fast::clamp(dot(l9_278.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_279=dot(l9_278.xyz,float3(0.33333001))*l9_278.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_279=1.0-fast::clamp(dot(l9_278.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_280=l9_279;
float l9_281=l9_280;
float l9_282=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_281;
float3 l9_283=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_277.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_284=float4(l9_283.x,l9_283.y,l9_283.z,l9_282);
param_50=l9_284;
}
else
{
...
{
float4 l9_285=param_50;
float4 l9_286=float4(0.0);
float4 l9_287=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_288=out.FragColor0;
float4 l9_289=l9_288;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_289.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
...
{
float4 l9_291=gl_FragCoord;
float2 l9_292=l9_291.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_297=l9_296;
int l9_298=l9_297;
float3 l9_299=float3(l9_293,0.0);
int l9_300=l9_295;
int l9_301=l9_298;
if (l9_300==1)
{
l9_299.y=((2.0*l9_299.y)+float(l9_301))-1.0;
}
float2 l9_302=l9_299.xy;
l9_294=l9_302;
}
else
{
...
int l9_319=sc_ScreenTextureLayout_tmp;
int l9_320=l9_315;
float l9_321=l9_316;
...
float l9_329=l9_321;
float4 l9_330=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_328,bias(l9_329));
float4 l9_331=l9_330;
l9_317=l9_331;
float4 l9_332=l9_317;
...
{
l9_287.x+=(*sc_set0.UserUniforms)._sc_GetFramebufferColorInvalidUsageMarker;
}
float4 l9_335=l9_287;
float4 l9_336=l9_335;
float3 l9_337=l9_336.xyz;
float3 l9_338=l9_337;
float3 l9_339=l9_285.xyz;
float3 l9_340=definedBlend(l9_338,l9_339,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_286=float4(l9_340.x,l9_340.y,l9_340.z,l9_286.w);
float3 l9_341=mix(l9_337,l9_286.xyz,float3(l9_285.w));
l9_286=float4(l9_341.x,l9_341.y,l9_341.z,l9_286.w);
l9_286.w=1.0;
float4 l9_342=l9_286;
param_50=l9_342;
}
else
{
float4 l9_343=param_50;
float4 l9_344=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_344=float4(mix(float3(1.0),l9_343.xyz,float3(l9_343.w)),l9_343.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_345=l9_343.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_345=fast::clamp(l9_345,0.0,1.0);
}
l9_344=float4(l9_343.xyz*l9_345,l9_345);
}
else
{
l9_344=l9_343;
...
{
l9_348=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_348=float4(0.0);
...
float4 l9_350=param_53;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_350.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_350;
return out;
}
} // FRAGMENT SHADER
