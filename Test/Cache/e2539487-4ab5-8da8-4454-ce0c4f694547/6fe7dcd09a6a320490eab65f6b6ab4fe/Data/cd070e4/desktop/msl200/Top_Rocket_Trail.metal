...
//sampler sampler texture_mapSmpSC 0:30
...
//texture texture2D texture_map 0:19:0:30
...
//float3x3 texture_mapTransform 4320
//float4 texture_mapUvMinMax 4368
//float4 texture_mapBorderColor 4384
//float Tweak_N44 4400
//float black_height 4404
//float Port_Multiplier_N039 4408
//float Port_Input1_N041 4412
//float Port_Input1_N043 4416
//float4 Port_Value0_N038 4432
//float Port_Position1_N038 4448
//float4 Port_Value1_N038 4464
//float4 Port_Value2_N038 4480
//float Port_Input0_N000 4496
//float Port_Input1_N000 4500
//float Port_Input0_N003 4504
//float Port_Input1_N003 4508
//float Port_Input0_N014 4512
//float Port_Input1_N014 4516
//float Port_Input1_N013 4520
//float2 Port_Scale_N032 4528
//float2 Port_Center_N032 4536
//float Port_Input1_N034 4544
//float2 Port_Direction_N037 4552
//float Port_Input1_N046 4560
//float Port_Input0_N045 4564
//float Port_Input1_N045 4568
//float Port_Input1_N047 4572
//float depthRef 4576
//}
...
//spec_const bool SC_USE_CLAMP_TO_BORDER_texture_map 32 0
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 33 0
//spec_const bool SC_USE_UV_MIN_MAX_texture_map 34 0
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 35 0
//spec_const bool SC_USE_UV_TRANSFORM_texture_map 36 0
...
//spec_const bool sc_BlendMode_Software 54 0
//spec_const bool sc_DepthOnly 55 0
//spec_const bool sc_FramebufferFetch 56 0
//spec_const bool sc_GetFramebufferColorInvalidUsageMarker 57 0
//spec_const bool sc_IsEditor 58 0
...
//spec_const bool sc_ProxyAlphaOne 65 0
...
//spec_const bool texture_mapHasSwappedViews 73 0
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 74 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_texture_map 75 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 76 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_texture_map 77 -1
...
//spec_const int texture_mapLayout 86 0
//SG_REFLECTION_END
...
constant bool SC_USE_CLAMP_TO_BORDER_texture_map [[function_constant(32)]];
...
constant bool SC_USE_UV_MIN_MAX_texture_map [[function_constant(34)]];
...
constant bool SC_USE_UV_TRANSFORM_texture_map [[function_constant(36)]];
...
constant bool sc_BlendMode_Software [[function_constant(54)]];
...
constant bool sc_GetFramebufferColorInvalidUsageMarker [[function_constant(57)]];
...
constant bool sc_IsEditor [[function_constant(58)]];
...
constant bool sc_ProxyAlphaOne [[function_constant(65)]];
...
constant bool texture_mapHasSwappedViews [[function_constant(73)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_texture_map [[function_constant(75)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_texture_map [[function_constant(77)]];
...
constant int texture_mapLayout [[function_constant(86)]];
...
float Time_N39=0.0;
Time_N39=Globals.gTimeElapsed*(*sc_set0.UserUniforms).Port_Multiplier_N039;
float4 Color_N36=float4(0.0);
Color_N36=Globals.VertexColor;
float Output_N42=0.0;
Output_N42=Color_N36.x;
float Output_N41=0.0;
Output_N41=Output_N42*(*sc_set0.UserUniforms).Port_Input1_N041;
float Output_N40=0.0;
Output_N40=Time_N39+Output_N41;
float Output_N43=0.0;
Output_N43=mod(Output_N40,(*sc_set0.UserUniforms).Port_Input1_N043);
float4 Value_N38=float4(0.0);
float param=Output_N43;
float4 param_1=(*sc_set0.UserUniforms).Port_Value0_N038;
float param_2=(*sc_set0.UserUniforms).Port_Position1_N038;
float4 param_3=(*sc_set0.UserUniforms).Port_Value1_N038;
float4 param_4=(*sc_set0.UserUniforms).Port_Value2_N038;
...
bool l9_5=(*sc_set0.UserUniforms).PreviewEnabled==1;
bool l9_6;
if (l9_5)
{
l9_6=!PreviewInfo.Saved;
}
else
{
l9_6=l9_5;
...
if (l9_6)
{
l9_7=38==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_7=l9_6;
...
float Output_N0=0.0;
Output_N0=smoothstep((*sc_set0.UserUniforms).Port_Input0_N000,(*sc_set0.UserUniforms).Port_Input1_N000,Output_N1);
float Output_N3=0.0;
Output_N3=smoothstep((*sc_set0.UserUniforms).Port_Input0_N003,(*sc_set0.UserUniforms).Port_Input1_N003,Output_N1);
float Output_N6=0.0;
...
Output_N13=abs(Output_N12-(*sc_set0.UserUniforms).Port_Input1_N013);
float Output_N14=0.0;
Output_N14=smoothstep((*sc_set0.UserUniforms).Port_Input0_N014,(*sc_set0.UserUniforms).Port_Input1_N014,Output_N13);
...
CoordsOut_N32=((UVCoord_N29-(*sc_set0.UserUniforms).Port_Center_N032)*(*sc_set0.UserUniforms).Port_Scale_N032)+(*sc_set0.UserUniforms).Port_Center_N032;
float4 Color_N30=float4(0.0);
Color_N30=Globals.VertexColor;
float Output_N35=0.0;
Output_N35=Color_N30.x;
float Output_N34=0.0;
Output_N34=Output_N35*(*sc_set0.UserUniforms).Port_Input1_N034;
float2 CoordsOut_N33=float2(0.0);
CoordsOut_N33=CoordsOut_N32+float2(Output_N34);
float Output_N44=0.0;
float param_6=(*sc_set0.UserUniforms).Tweak_N44;
Output_N44=param_6;
float Output_N46=0.0;
Output_N46=Output_N44*(*sc_set0.UserUniforms).Port_Input1_N046;
float2 CoordsOut_N37=float2(0.0);
CoordsOut_N37=CoordsOut_N33+((*sc_set0.UserUniforms).Port_Direction_N037*(Globals.gTimeElapsed*Output_N46));
...
float3x3 param_11=(*sc_set0.UserUniforms).texture_mapTransform;
...
float4 param_14=(*sc_set0.UserUniforms).texture_mapUvMinMax;
bool param_15=(int(SC_USE_CLAMP_TO_BORDER_texture_map_tmp)!=0);
float4 param_16=(*sc_set0.UserUniforms).texture_mapBorderColor;
float param_17=0.0;
bool l9_14=param_15&&(!param_13);
float l9_15=1.0;
float l9_16=param_9.x;
int l9_17=param_12.x;
if (l9_17==1)
{
l9_16=fract(l9_16);
}
...
param_9.x=l9_16;
float l9_21=param_9.y;
int l9_22=param_12.y;
if (l9_22==1)
{
l9_21=fract(l9_21);
}
...
float l9_28=param_9.x;
float l9_29=param_14.x;
float l9_30=param_14.z;
bool l9_31=l9_27;
float l9_32=l9_15;
float l9_33=fast::clamp(l9_28,l9_29,l9_30);
float l9_34=step(abs(l9_28-l9_33),9.9999997e-06);
l9_32*=(l9_34+((1.0-float(l9_31))*(1.0-l9_34)));
l9_28=l9_33;
param_9.x=l9_28;
l9_15=l9_32;
bool l9_35=param_15;
...
float l9_37=param_9.y;
float l9_38=param_14.y;
float l9_39=param_14.w;
bool l9_40=l9_36;
float l9_41=l9_15;
...
float2 l9_44=param_9;
bool l9_45=param_10;
float3x3 l9_46=param_11;
if (l9_45)
{
l9_44=float2((l9_46*float3(l9_44,1.0)).xy);
}
float2 l9_47=l9_44;
float2 l9_48=l9_47;
float2 l9_49=l9_48;
param_9=l9_49;
float l9_50=param_9.x;
int l9_51=param_12.x;
bool l9_52=l9_14;
float l9_53=l9_15;
if ((l9_51==0)||(l9_51==3))
{
...
param_9.x=l9_50;
l9_15=l9_53;
float l9_61=param_9.y;
int l9_62=param_12.y;
bool l9_63=l9_14;
float l9_64=l9_15;
if ((l9_62==0)||(l9_62==3))
{
...
param_9.y=l9_61;
l9_15=l9_64;
float2 l9_72=param_9;
int l9_73=param_7;
int l9_74=param_8;
float l9_75=param_17;
float2 l9_76=l9_72;
int l9_77=l9_73;
int l9_78=l9_74;
...
float l9_83=l9_75;
float4 l9_84=sc_set0.texture_map.sample(sc_set0.texture_mapSmpSC,l9_82,bias(l9_83));
float4 l9_85=l9_84;
float4 l9_86=l9_85;
if (param_15)
{
l9_86=mix(param_16,l9_86,float4(l9_15));
}
float4 l9_87=l9_86;
Color_N27=l9_87;
...
Output_N45=smoothstep((*sc_set0.UserUniforms).Port_Input0_N045,(*sc_set0.UserUniforms).Port_Input1_N045,Output_N44);
...
float param_18=(*sc_set0.UserUniforms).black_height;
Output_N51=param_18;
float Output_N49=0.0;
Output_N49=float(Output_N52<Output_N51);
float Output_N47=0.0;
Output_N47=mix(Output_N18.x,(*sc_set0.UserUniforms).Port_Input1_N047,Output_N49);
...
bool l9_91=(*sc_set0.UserUniforms).isProxyMode!=0;
if (l9_91)
{
...
float4 l9_92=fast::max(param_20,float4(0.0));
float4 param_21=l9_92;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
l9_95=fast::clamp(l9_94.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_95=fast::clamp(dot(l9_94.xyz,float3(l9_94.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_95=(1.0-dot(l9_94.xyz,float3(0.33333001)))*l9_94.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_95=(1.0-fast::clamp(dot(l9_94.xyz,float3(1.0)),0.0,1.0))*l9_94.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_95=fast::clamp(dot(l9_94.xyz,float3(1.0)),0.0,1.0)*l9_94.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_95=fast::clamp(dot(l9_94.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_95=dot(l9_94.xyz,float3(0.33333001))*l9_94.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_95=1.0-fast::clamp(dot(l9_94.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_96=l9_95;
float l9_97=l9_96;
float l9_98=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_97;
float3 l9_99=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_93.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_100=float4(l9_99.x,l9_99.y,l9_99.z,l9_98);
param_22=l9_100;
}
else
{
...
{
float4 l9_101=param_22;
float4 l9_102=float4(0.0);
float4 l9_103=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_104=out.FragColor0;
float4 l9_105=l9_104;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_105.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
float4 l9_106=l9_105;
l9_103=l9_106;
}
...
{
float4 l9_107=gl_FragCoord;
float2 l9_108=l9_107.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_113=l9_112;
int l9_114=l9_113;
float3 l9_115=float3(l9_109,0.0);
int l9_116=l9_111;
int l9_117=l9_114;
if (l9_116==1)
{
l9_115.y=((2.0*l9_115.y)+float(l9_117))-1.0;
}
...
int l9_135=sc_ScreenTextureLayout_tmp;
int l9_136=l9_131;
float l9_137=l9_132;
...
float l9_145=l9_137;
float4 l9_146=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_144,bias(l9_145));
float4 l9_147=l9_146;
l9_133=l9_147;
float4 l9_148=l9_133;
...
{
l9_103.x+=(*sc_set0.UserUniforms)._sc_GetFramebufferColorInvalidUsageMarker;
}
float4 l9_151=l9_103;
float4 l9_152=l9_151;
float3 l9_153=l9_152.xyz;
float3 l9_154=l9_153;
float3 l9_155=l9_101.xyz;
float3 l9_156=definedBlend(l9_154,l9_155,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_102=float4(l9_156.x,l9_156.y,l9_156.z,l9_102.w);
float3 l9_157=mix(l9_153,l9_102.xyz,float3(l9_101.w));
l9_102=float4(l9_157.x,l9_157.y,l9_157.z,l9_102.w);
l9_102.w=1.0;
float4 l9_158=l9_102;
param_22=l9_158;
}
else
{
float4 l9_159=param_22;
float4 l9_160=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_160=float4(mix(float3(1.0),l9_159.xyz,float3(l9_159.w)),l9_159.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_161=l9_159.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_161=fast::clamp(l9_161,0.0,1.0);
}
l9_160=float4(l9_159.xyz*l9_161,l9_161);
}
else
{
l9_160=l9_159;
...
float4 l9_162=l9_160;
param_22=l9_162;
}
}
}
float4 l9_163=param_22;
FinalColor=l9_163;
if ((*sc_set0.UserUniforms).PreviewEnabled==1)
{
if (PreviewInfo.Saved)
...
{
l9_164=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_164=float4(0.0);
