...
//}
//ubo int UserUniforms 0:24:4528 {
//float4 sc_Time 1376
...
//float height_gradient 4128
//float distance_gradient 4132
//float alpha 4136
//float Port_Input1_N021 4140
//float4 Port_Value1_N025 4144
//float4 Port_Default_N025 4160
//float Port_Input1_N040 4176
//float Port_Input1_N043 4180
//float3 Port_Normal_N014 4192
//float Port_Exponent_N014 4208
//float Port_Intensity_N014 4212
//float Port_Input1_N017 4216
//float Port_Input1_N097 4220
//float Port_RangeMinA_N103 4224
//float Port_RangeMaxA_N103 4228
//float Port_RangeMinB_N103 4232
//float Port_RangeMaxB_N103 4236
//float Port_Input1_N069 4240
//float Port_Input2_N069 4244
//float Port_Value1_N076 4248
//float Port_Value3_N076 4252
//float4 Port_Value0_N077 4256
//float Port_Position1_N077 4272
//float4 Port_Value1_N077 4288
//float Port_Position2_N077 4304
//float4 Port_Value2_N077 4320
//float Port_Position3_N077 4336
//float4 Port_Value3_N077 4352
//float4 Port_Value4_N077 4368
//float Port_Amount_N080 4384
//float Port_Input1_N070 4388
//float Port_Input1_N071 4392
//float4 Port_Value0_N068 4400
//float Port_Position1_N068 4416
//float4 Port_Value1_N068 4432
//float4 Port_Value2_N068 4448
//float Port_Input1_N072 4464
//float3 Port_Default_N066 4480
//float3 Port_Value1_N038 4496
//float3 Port_Default_N038 4512
//}
...
l9_119=param_6.SurfacePosition_ObjectSpace;
float l9_120=0.0;
l9_120=l9_119.y;
float l9_121=0.0;
l9_121=float(l9_120<(*sc_set0.UserUniforms).Port_Input1_N021);
param_1=l9_121;
...
int l9_136=l9_135;
l9_134=((*sc_set0.UserUniforms).sc_ModelViewMatrixArray[l9_136]*param_7.position)*float4(1.0/(*sc_set0.UserUniforms).sc_Camera.aspect,1.0,1.0,1.0);
}
else
{
if (sc_RenderingSpace_tmp==2)
...
int l9_138=l9_137;
l9_134=(*sc_set0.UserUniforms).sc_ViewProjectionMatrixArray[l9_138]*float4(out.varPos,1.0);
}
else
{
if (sc_RenderingSpace_tmp==1)
...
int l9_140=l9_139;
l9_134=(*sc_set0.UserUniforms).sc_ViewProjectionMatrixArray[l9_140]*float4(out.varPos,1.0);
}
}
}
}
...
{
float4 l9_141=param_7.position;
...
{
float l9_64=0.0;
float3 l9_65=(*sc_set0.UserUniforms).Port_Normal_N014;
float l9_66=(*sc_set0.UserUniforms).Port_Exponent_N014;
float l9_67=(*sc_set0.UserUniforms).Port_Intensity_N014;
ssGlobals l9_68=l9_8;
l9_65=float3x3(float3(l9_68.VertexTangent_WorldSpace),float3(l9_68.VertexBinormal_WorldSpace),float3(l9_68.VertexNormal_WorldSpace))*l9_65;
float l9_69=abs(dot(-l9_68.ViewDirWS,l9_65));
float l9_70=pow(1.0-l9_69,l9_66);
l9_70=fast::max(l9_70,0.0);
l9_70*=l9_67;
l9_64=l9_70;
float3 l9_71=float3(0.0);
l9_71=l9_8.SurfacePosition_WorldSpace;
float3 l9_72=float3(0.0);
l9_72=(*sc_set0.UserUniforms).sc_Camera.position;
float l9_73=0.0;
l9_73=distance(l9_71,l9_72);
float l9_74=0.0;
l9_74=l9_73*(*sc_set0.UserUniforms).Port_Input1_N097;
float l9_75=0.0;
float l9_76=l9_74;
float l9_77=(*sc_set0.UserUniforms).Port_RangeMinA_N103;
float l9_78=(*sc_set0.UserUniforms).Port_RangeMaxA_N103;
float l9_79=(*sc_set0.UserUniforms).Port_RangeMinB_N103;
float l9_80=(*sc_set0.UserUniforms).Port_RangeMaxB_N103;
float l9_81=(((l9_76-l9_77)/((l9_78-l9_77)+1e-06))*(l9_80-l9_79))+l9_79;
float l9_82;
if (l9_80>l9_79)
{
l9_82=fast::clamp(l9_81,l9_79,l9_80);
}
else
{
l9_82=fast::clamp(l9_81,l9_80,l9_79);
}
l9_81=l9_82;
l9_75=l9_81;
float l9_83=0.0;
l9_83=(l9_64*(*sc_set0.UserUniforms).Port_Input1_N017)+l9_75;
float l9_84=0.0;
l9_84=1.0-l9_83;
float l9_85=0.0;
l9_85=fast::clamp(l9_84+0.001,(*sc_set0.UserUniforms).Port_Input1_N069+0.001,(*sc_set0.UserUniforms).Port_Input2_N069+0.001)-0.001;
float3 l9_86=float3(0.0);
l9_86=l9_8.SurfacePosition_ObjectSpace;
float l9_87=0.0;
float l9_88=(*sc_set0.UserUniforms).height_gradient;
l9_87=l9_88;
float3 l9_89=float3(0.0);
l9_89.x=(*sc_set0.UserUniforms).Port_Value1_N076;
l9_89.y=l9_87;
l9_89.z=(*sc_set0.UserUniforms).Port_Value3_N076;
float l9_90=0.0;
l9_90=distance(l9_86,l9_89);
float l9_91=0.0;
float l9_92=(*sc_set0.UserUniforms).distance_gradient;
l9_91=l9_92;
float l9_93=0.0;
l9_93=1.0-l9_91;
float l9_94=0.0;
...
float l9_96=l9_94;
float4 l9_97=(*sc_set0.UserUniforms).Port_Value0_N077;
float l9_98=(*sc_set0.UserUniforms).Port_Position1_N077;
float4 l9_99=(*sc_set0.UserUniforms).Port_Value1_N077;
float l9_100=(*sc_set0.UserUniforms).Port_Position2_N077;
float4 l9_101=(*sc_set0.UserUniforms).Port_Value2_N077;
float l9_102=(*sc_set0.UserUniforms).Port_Position3_N077;
float4 l9_103=(*sc_set0.UserUniforms).Port_Value3_N077;
float4 l9_104=(*sc_set0.UserUniforms).Port_Value4_N077;
l9_96=fast::clamp(l9_96,0.0,1.0);
float4 l9_105;
if (l9_96<l9_98)
{
l9_105=mix(l9_97,l9_99,float4(fast::clamp(l9_96/l9_98,0.0,1.0)));
}
else
{
if (l9_96<l9_100)
{
l9_105=mix(l9_99,l9_101,float4(fast::clamp((l9_96-l9_98)/(l9_100-l9_98),0.0,1.0)));
}
else
{
if (l9_96<l9_102)
{
l9_105=mix(l9_101,l9_103,float4(fast::clamp((l9_96-l9_100)/(l9_102-l9_100),0.0,1.0)));
}
else
{
l9_105=mix(l9_103,l9_104,float4(fast::clamp((l9_96-l9_102)/(1.0-l9_102),0.0,1.0)));
}
}
}
bool l9_106=(*sc_set0.UserUniforms).PreviewEnabled==1;
bool l9_107;
if (l9_106)
{
l9_107=!PreviewInfo.Saved;
}
else
{
l9_107=l9_106;
...
if (l9_107)
{
l9_108=77==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_108=l9_107;
...
{
PreviewInfo.Saved=true;
PreviewInfo.Color=l9_105;
PreviewInfo.Color.w=1.0;
}
l9_95=l9_105;
float4 l9_109=float4(0.0);
float4 l9_110=l9_95;
float l9_111=(*sc_set0.UserUniforms).Port_Amount_N080;
float l9_112=dot(l9_110.xyz,float3(0.29899999,0.58700001,0.114));
float4 l9_113=float4(mix(float3(l9_112),l9_110.xyz,float3(l9_111)),l9_110.w);
l9_109=l9_113;
float4 l9_114=float4(0.0);
l9_114=float4(l9_85)*l9_109;
float3 l9_115=float3(0.0);
l9_115=l9_8.SurfacePosition_ObjectSpace;
float l9_116=0.0;
l9_116=l9_115.y;
float l9_117=0.0;
l9_117=floor(l9_116*(*sc_set0.UserUniforms).Port_Input1_N070)/(*sc_set0.UserUniforms).Port_Input1_N070;
float l9_118=0.0;
float l9_119;
if (l9_117<=0.0)
{
...
{
l9_119=pow(l9_117,(*sc_set0.UserUniforms).Port_Input1_N071);
}
l9_118=l9_119;
float4 l9_120=float4(0.0);
float l9_121=l9_118;
float4 l9_122=(*sc_set0.UserUniforms).Port_Value0_N068;
float l9_123=(*sc_set0.UserUniforms).Port_Position1_N068;
float4 l9_124=(*sc_set0.UserUniforms).Port_Value1_N068;
float4 l9_125=(*sc_set0.UserUniforms).Port_Value2_N068;
...
if (l9_128)
{
l9_129=68==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_129=l9_128;
...
l9_130=l9_120*float4((*sc_set0.UserUniforms).Port_Input1_N072);
float4 l9_131=float4(0.0);
l9_131=l9_114*l9_130;
l9_6=l9_131.xyz;
l9_12=l9_6;
}
else
...
{
l9_137=fast::clamp(l9_136.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_137=fast::clamp(dot(l9_136.xyz,float3(l9_136.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_137=(1.0-dot(l9_136.xyz,float3(0.33333001)))*l9_136.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_137=(1.0-fast::clamp(dot(l9_136.xyz,float3(1.0)),0.0,1.0))*l9_136.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_137=fast::clamp(dot(l9_136.xyz,float3(1.0)),0.0,1.0)*l9_136.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_137=fast::clamp(dot(l9_136.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_137=dot(l9_136.xyz,float3(0.33333001))*l9_136.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_137=1.0-fast::clamp(dot(l9_136.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_138=l9_137;
float l9_139=l9_138;
float l9_140=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_139;
float3 l9_141=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_135.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_142=float4(l9_141.x,l9_141.y,l9_141.z,l9_140);
param_8=l9_142;
}
else
{
...
{
float4 l9_143=param_8;
float4 l9_144=float4(0.0);
float4 l9_145=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_146=out.FragColor0;
float4 l9_147=l9_146;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_147.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
...
int l9_169=l9_164;
float2 l9_170=l9_163;
int l9_171=l9_169;
float2 l9_172=l9_170;
int l9_173=l9_171;
float l9_174=0.0;
float4 l9_175=float4(0.0);
float2 l9_176=l9_172;
int l9_177=sc_ScreenTextureLayout_tmp;
int l9_178=l9_173;
float l9_179=l9_174;
...
float l9_187=l9_179;
float4 l9_188=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_186,bias(l9_187));
float4 l9_189=l9_188;
l9_175=l9_189;
float4 l9_190=l9_175;
...
{
l9_145.x+=(*sc_set0.UserUniforms)._sc_GetFramebufferColorInvalidUsageMarker;
}
float4 l9_193=l9_145;
float4 l9_194=l9_193;
float3 l9_195=l9_194.xyz;
float3 l9_196=l9_195;
float3 l9_197=l9_143.xyz;
float3 l9_198=definedBlend(l9_196,l9_197,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_144=float4(l9_198.x,l9_198.y,l9_198.z,l9_144.w);
float3 l9_199=mix(l9_195,l9_144.xyz,float3(l9_143.w));
l9_144=float4(l9_199.x,l9_199.y,l9_199.z,l9_144.w);
l9_144.w=1.0;
float4 l9_200=l9_144;
param_8=l9_200;
}
else
{
float4 l9_201=param_8;
float4 l9_202=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_202=float4(mix(float3(1.0),l9_201.xyz,float3(l9_201.w)),l9_201.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_203=l9_201.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_203=fast::clamp(l9_203,0.0,1.0);
}
l9_202=float4(l9_201.xyz*l9_203,l9_203);
}
else
{
l9_202=l9_201;
...
{
l9_206=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_206=float4(0.0);
