...
//float4 Port_Value0_N005 4416
//float Port_Position1_N005 4432
//float4 Port_Value1_N005 4448
//float Port_Position2_N005 4464
//float4 Port_Value2_N005 4480
//float4 Port_Value3_N005 4496
...
float4 param_12=(*sc_set0.UserUniforms).Port_Value0_N005;
float param_13=(*sc_set0.UserUniforms).Port_Position1_N005;
float4 param_14=(*sc_set0.UserUniforms).Port_Value1_N005;
float param_15=(*sc_set0.UserUniforms).Port_Position2_N005;
float4 param_16=(*sc_set0.UserUniforms).Port_Value2_N005;
float4 param_17=(*sc_set0.UserUniforms).Port_Value3_N005;
...
if (l9_86)
{
l9_87=5==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_87=l9_86;
...
Output_N3=float4(float(Value_N5.x<(*sc_set0.UserUniforms).Port_Input1_N003),float(Value_N5.y<(*sc_set0.UserUniforms).Port_Input1_N003),float(Value_N5.z<(*sc_set0.UserUniforms).Port_Input1_N003),float(Value_N5.w<(*sc_set0.UserUniforms).Port_Input1_N003));
