...
//spec_const bool sc_ProjectiveShadowsCaster 74 0
//spec_const bool sc_ProjectiveShadowsReceiver 75 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N6 83 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 84 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_planet_refl_map 85 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N6 86 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 87 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_planet_refl_map 88 -1
//spec_const int Tweak_N6Layout 89 0
//spec_const int intensityTextureLayout 90 0
//spec_const int planet_refl_mapLayout 91 0
//spec_const int sc_DepthBufferMode 92 0
//spec_const int sc_RenderingSpace 93 -1
//spec_const int sc_ScreenTextureLayout 94 0
//spec_const int sc_ShaderCacheConstant 95 0
//spec_const int sc_SkinBonesCount 96 0
//spec_const int sc_StereoRenderingMode 97 0
//spec_const int sc_StereoRendering_IsClipDistanceEnabled 98 0
//spec_const int sc_StereoViewID 99 0
//SG_REFLECTION_END
...
bool l9_5=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_planet_refl_map)!=0));
float l9_6=N15_ReflectionUV.x;
sc_SoftwareWrapEarly(l9_6,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x);
float l9_7=l9_6;
float l9_8=N15_ReflectionUV.y;
sc_SoftwareWrapEarly(l9_8,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y);
float l9_9=l9_8;
vec2 l9_10;
float l9_11;
...
{
l9_12=ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x==3;
}
#else
{
l9_12=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0);
}
#endif
float l9_13=l9_7;
float l9_14=1.0;
sc_ClampUV(l9_13,planet_refl_mapUvMinMax.x,planet_refl_mapUvMinMax.z,l9_12,l9_14);
float l9_15=l9_13;
float l9_16=l9_14;
bool l9_17;
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
l9_17=ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y==3;
}
#else
{
l9_17=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0);
}
#endif
float l9_18=l9_9;
float l9_19=l9_16;
sc_ClampUV(l9_18,planet_refl_mapUvMinMax.y,planet_refl_mapUvMinMax.w,l9_17,l9_19);
l9_11=l9_19;
...
#endif
vec2 l9_20=sc_TransformUV(l9_10,(int(SC_USE_UV_TRANSFORM_planet_refl_map)!=0),planet_refl_mapTransform);
float l9_21=l9_20.x;
float l9_22=l9_11;
sc_SoftwareWrapLate(l9_21,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x,l9_5,l9_22);
float l9_23=l9_20.y;
float l9_24=l9_22;
sc_SoftwareWrapLate(l9_23,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y,l9_5,l9_24);
float l9_25=l9_24;
vec3 l9_26=sc_SamplingCoordsViewToGlobal(vec2(l9_21,l9_23),planet_refl_mapLayout,planet_refl_mapGetStereoViewIndex());
vec4 l9_27=texture2D(planet_refl_map,l9_26.xy,0.0);
vec4 l9_28;
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
l9_28=mix(planet_refl_mapBorderColor,l9_27,vec4(l9_25));
}
#else
{
l9_28=l9_27;
...
vec4 l9_29=(vec4(reflIntensity)*l9_28)+param_10;
vec2 l9_30=Port_Import_N060-Port_Import_N058;
vec4 l9_31=vec4(l9_29.x,l9_29.y,l9_29.z,vec4(0.0).w);
l9_31.w=mix(vec4(l9_29.w),Port_Input1_N029,mix(Port_Import_N038,Port_Import_N031,vec4(smoothstep(Port_Input0_N066,Port_Input1_N066,clamp((dot((((((((Globals.Surface_UVCoord0-vec2(Port_RangeMinA_N033))/vec2((Port_RangeMaxA_N033-Port_RangeMinA_N033)+1e-06))*(Port_RangeMaxB_N033-Port_RangeMinB_N033))+vec2(Port_RangeMinB_N033))-Port_Center_N047)*Globals.Surface_UVCoord0)+Port_Center_N047)-Port_Import_N058,l9_30)/dot(l9_30,l9_30))+0.001,Port_Input1_N065+0.001,Port_Input2_N065+0.001)-0.001)))).x;
Value1=l9_31;
Result=Value1;
}
#else
...
N15_NormalSpace=1;
N15_Normal=Port_Import_N013;
vec3 l9_32=N15_Normal;
vec3 l9_33;
if (N15_NormalSpace==1)
{
l9_33=normalize(mat3(Globals.VertexTangent_WorldSpace,Globals.VertexBinormal_WorldSpace,Globals.VertexNormal_WorldSpace)*l9_32);
}
else
{
l9_33=l9_32;
}
vec3 l9_34=normalize(-Globals.ViewDirWS);
vec3 l9_35=normalize(cross(l9_34,sc_ViewMatrixInverseArray[sc_GetStereoViewIndex()][1].xyz));
vec3 l9_36=cross(l9_35,l9_34);
N15_ReflectionUV=((mat3(vec3(l9_35.x,l9_36.x,l9_34.x),vec3(l9_35.y,l9_36.y,l9_34.y),vec3(l9_35.z,l9_36.z,l9_34.z))*l9_33).xy*0.5)+vec2(0.5);
bool l9_37=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_planet_refl_map)!=0));
float l9_38=N15_ReflectionUV.x;
sc_SoftwareWrapEarly(l9_38,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x);
float l9_39=l9_38;
float l9_40=N15_ReflectionUV.y;
sc_SoftwareWrapEarly(l9_40,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y);
float l9_41=l9_40;
vec2 l9_42;
float l9_43;
#if (SC_USE_UV_MIN_MAX_planet_refl_map)
...
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
l9_44=ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x==3;
}
#else
{
l9_44=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0);
}
#endif
float l9_45=l9_39;
float l9_46=1.0;
sc_ClampUV(l9_45,planet_refl_mapUvMinMax.x,planet_refl_mapUvMinMax.z,l9_44,l9_46);
float l9_47=l9_45;
float l9_48=l9_46;
bool l9_49;
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
l9_49=ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y==3;
}
#else
{
l9_49=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0);
}
#endif
float l9_50=l9_41;
float l9_51=l9_48;
sc_ClampUV(l9_50,planet_refl_mapUvMinMax.y,planet_refl_mapUvMinMax.w,l9_49,l9_51);
l9_43=l9_51;
...
#endif
vec2 l9_52=sc_TransformUV(l9_42,(int(SC_USE_UV_TRANSFORM_planet_refl_map)!=0),planet_refl_mapTransform);
float l9_53=l9_52.x;
float l9_54=l9_43;
sc_SoftwareWrapLate(l9_53,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x,l9_37,l9_54);
float l9_55=l9_52.y;
float l9_56=l9_54;
sc_SoftwareWrapLate(l9_55,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y,l9_37,l9_56);
float l9_57=l9_56;
vec3 l9_58=sc_SamplingCoordsViewToGlobal(vec2(l9_53,l9_55),planet_refl_mapLayout,planet_refl_mapGetStereoViewIndex());
vec4 l9_59=texture2D(planet_refl_map,l9_58.xy,0.0);
vec4 l9_60;
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
l9_60=mix(planet_refl_mapBorderColor,l9_59,vec4(l9_57));
}
#else
{
l9_60=l9_59;
...
Default=(vec4(reflIntensity)*l9_60)+param_22;
Result=Default;
}
#endif
}
...
vec4 param_3;
Node55_If_else(0.0,vec4(0.0),vec4(0.0),param_3,ssGlobals(sc_Time.x,sc_Time.y,0.0,l9_0,l9_1,cross(l9_0,l9_1)*varTangent.w,normalize(sc_Camera.position-varPos),varPos,varPackedTex.xy,varPackedTex.zw));
vec4 l9_2=param_3;
int l9_3;
...
#endif
bool l9_4=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N6)!=0));
float l9_5=varPackedTex.z;
sc_SoftwareWrapEarly(l9_5,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x);
float l9_6=l9_5;
float l9_7=varPackedTex.w;
sc_SoftwareWrapEarly(l9_7,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y);
float l9_8=l9_7;
vec2 l9_9;
float l9_10;
...
{
l9_11=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x==3;
}
#else
{
l9_11=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0);
}
#endif
float l9_12=l9_6;
float l9_13=1.0;
sc_ClampUV(l9_12,Tweak_N6UvMinMax.x,Tweak_N6UvMinMax.z,l9_11,l9_13);
float l9_14=l9_12;
float l9_15=l9_13;
bool l9_16;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_16=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y==3;
}
#else
{
l9_16=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0);
}
#endif
float l9_17=l9_8;
float l9_18=l9_15;
sc_ClampUV(l9_17,Tweak_N6UvMinMax.y,Tweak_N6UvMinMax.w,l9_16,l9_18);
l9_10=l9_18;
...
#endif
vec2 l9_19=sc_TransformUV(l9_9,(int(SC_USE_UV_TRANSFORM_Tweak_N6)!=0),Tweak_N6Transform);
float l9_20=l9_19.x;
float l9_21=l9_10;
sc_SoftwareWrapLate(l9_20,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x,l9_4,l9_21);
float l9_22=l9_19.y;
float l9_23=l9_21;
sc_SoftwareWrapLate(l9_22,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y,l9_4,l9_23);
float l9_24=l9_23;
vec3 l9_25=sc_SamplingCoordsViewToGlobal(vec2(l9_20,l9_22),Tweak_N6Layout,l9_3);
vec4 l9_26=texture2D(Tweak_N6,l9_25.xy,0.0);
vec4 l9_27;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_27=mix(Tweak_N6BorderColor,l9_26,vec4(l9_24));
}
#else
{
l9_27=l9_26;
...
#endif
vec3 l9_28=mix(l9_2.xyz,(l9_27.xyz*l9_2.xyz).xyz,vec3(l9_27.w));
...
{
l9_32=clamp(l9_2.w*2.0,0.0,1.0);
}
#else
{
float l9_33;
...
{
l9_33=clamp(dot(l9_29.xyz,vec3(l9_2.w)),0.0,1.0);
}
#else
{
float l9_34;
...
{
l9_35=(1.0-dot(l9_29.xyz,vec3(0.33333001)))*l9_2.w;
}
#else
{
float l9_36;
...
{
l9_36=(1.0-clamp(dot(l9_29.xyz,vec3(1.0)),0.0,1.0))*l9_2.w;
}
#else
{
float l9_37;
...
{
l9_37=clamp(dot(l9_29.xyz,vec3(1.0)),0.0,1.0)*l9_2.w;
}
#else
{
float l9_38;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_39=clamp(dot(l9_29.xyz,vec3(1.0)),0.0,1.0)*l9_2.w;
}
#else
{
float l9_40;
...
{
l9_40=dot(l9_29.xyz,vec3(0.33333001))*l9_2.w;
}
#else
{
float l9_41;
...
#endif
l9_45=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_49,sc_ScreenTextureLayout,l9_50).xy,0.0);
}
#endif
vec4 l9_51;
...
#endif
vec3 l9_53=mix(l9_51.xyz,definedBlend(l9_51.xyz,l9_29.xyz).xyz,vec3(l9_2.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_55=vec4(mix(vec3(1.0),l9_29.xyz,vec3(l9_2.w)),l9_2.w);
}
#else
{
vec4 l9_56;
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_64-0.0039215689)),min(1.0,l9_64+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_66),packValue(l9_66),packValue(l9_66),packValue(l9_66)),sc_UniformConstants.x,sc_ShaderCacheConstant);
...
#else
{
sc_writeFragData0Internal(l9_62,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif
