...
//float Port_Rotation_N001 4272
//float2 Port_Center_N001 4280
//float4 Port_Value0_N000 4288
//float Port_Position1_N000 4304
//float4 Port_Value1_N000 4320
//float Port_Position2_N000 4336
//float4 Port_Value2_N000 4352
//float Port_Position3_N000 4368
//float4 Port_Value3_N000 4384
//float Port_Position4_N000 4400
//float4 Port_Value4_N000 4416
//float Port_Position5_N000 4432
//float4 Port_Value5_N000 4448
//float Port_Position6_N000 4464
//float4 Port_Value6_N000 4480
//float4 Port_Value7_N000 4496
//float Port_Value0_N002 4512
//float Port_Position1_N002 4516
//float Port_Value1_N002 4520
//float Port_Position2_N002 4524
//float Port_Value2_N002 4528
//float Port_Position3_N002 4532
//float Port_Value3_N002 4536
//float Port_Position4_N002 4540
//float Port_Value4_N002 4544
//float Port_Position5_N002 4548
//float Port_Value5_N002 4552
//float Port_Position6_N002 4556
//float Port_Value6_N002 4560
//float Port_Position7_N002 4564
//float Port_Value7_N002 4568
//float Port_Position8_N002 4572
//float Port_Value8_N002 4576
//float Port_Position9_N002 4580
//float Port_Value9_N002 4584
//float Port_Position10_N002 4588
//float Port_Value10_N002 4592
//float Port_Position11_N002 4596
//float Port_Value11_N002 4600
//float Port_Position12_N002 4604
//float Port_Value12_N002 4608
//float Port_Position13_N002 4612
//float Port_Value13_N002 4616
//float Port_Position14_N002 4620
//float Port_Value14_N002 4624
//float Port_Value15_N002 4628
//float depthRef 4632
//}
...
float param_1=(*sc_set0.UserUniforms).Port_Rotation_N001;
float2 param_2=(*sc_set0.UserUniforms).Port_Center_N001;
float l9_5=sin(radians(param_1));
float l9_6=cos(radians(param_1));
float2 param_3=param-param_2;
param_3=float2(dot(float2(l9_6,l9_5),param_3),dot(float2(-l9_5,l9_6),param_3))+param_2;
CoordsOut_N1=param_3;
float4 Value_N0=float4(0.0);
float param_4=CoordsOut_N1.x;
float4 param_5=(*sc_set0.UserUniforms).Port_Value0_N000;
float param_6=(*sc_set0.UserUniforms).Port_Position1_N000;
float4 param_7=(*sc_set0.UserUniforms).Port_Value1_N000;
float param_8=(*sc_set0.UserUniforms).Port_Position2_N000;
float4 param_9=(*sc_set0.UserUniforms).Port_Value2_N000;
float param_10=(*sc_set0.UserUniforms).Port_Position3_N000;
float4 param_11=(*sc_set0.UserUniforms).Port_Value3_N000;
float param_12=(*sc_set0.UserUniforms).Port_Position4_N000;
float4 param_13=(*sc_set0.UserUniforms).Port_Value4_N000;
float param_14=(*sc_set0.UserUniforms).Port_Position5_N000;
float4 param_15=(*sc_set0.UserUniforms).Port_Value5_N000;
float param_16=(*sc_set0.UserUniforms).Port_Position6_N000;
float4 param_17=(*sc_set0.UserUniforms).Port_Value6_N000;
float4 param_18=(*sc_set0.UserUniforms).Port_Value7_N000;
...
bool l9_7=(*sc_set0.UserUniforms).PreviewEnabled==1;
bool l9_8;
if (l9_7)
{
...
if (l9_8)
{
l9_9=0==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_9=l9_8;
...
float param_21=(*sc_set0.UserUniforms).Port_Value0_N002;
float param_22=(*sc_set0.UserUniforms).Port_Position1_N002;
float param_23=(*sc_set0.UserUniforms).Port_Value1_N002;
float param_24=(*sc_set0.UserUniforms).Port_Position2_N002;
float param_25=(*sc_set0.UserUniforms).Port_Value2_N002;
float param_26=(*sc_set0.UserUniforms).Port_Position3_N002;
float param_27=(*sc_set0.UserUniforms).Port_Value3_N002;
float param_28=(*sc_set0.UserUniforms).Port_Position4_N002;
float param_29=(*sc_set0.UserUniforms).Port_Value4_N002;
float param_30=(*sc_set0.UserUniforms).Port_Position5_N002;
float param_31=(*sc_set0.UserUniforms).Port_Value5_N002;
float param_32=(*sc_set0.UserUniforms).Port_Position6_N002;
float param_33=(*sc_set0.UserUniforms).Port_Value6_N002;
float param_34=(*sc_set0.UserUniforms).Port_Position7_N002;
float param_35=(*sc_set0.UserUniforms).Port_Value7_N002;
float param_36=(*sc_set0.UserUniforms).Port_Position8_N002;
float param_37=(*sc_set0.UserUniforms).Port_Value8_N002;
float param_38=(*sc_set0.UserUniforms).Port_Position9_N002;
float param_39=(*sc_set0.UserUniforms).Port_Value9_N002;
float param_40=(*sc_set0.UserUniforms).Port_Position10_N002;
float param_41=(*sc_set0.UserUniforms).Port_Value10_N002;
float param_42=(*sc_set0.UserUniforms).Port_Position11_N002;
float param_43=(*sc_set0.UserUniforms).Port_Value11_N002;
float param_44=(*sc_set0.UserUniforms).Port_Position12_N002;
float param_45=(*sc_set0.UserUniforms).Port_Value12_N002;
float param_46=(*sc_set0.UserUniforms).Port_Position13_N002;
float param_47=(*sc_set0.UserUniforms).Port_Value13_N002;
float param_48=(*sc_set0.UserUniforms).Port_Position14_N002;
float param_49=(*sc_set0.UserUniforms).Port_Value14_N002;
float param_50=(*sc_set0.UserUniforms).Port_Value15_N002;
...
bool l9_10=(*sc_set0.UserUniforms).PreviewEnabled==1;
bool l9_11;
if (l9_10)
{
...
if (l9_11)
{
l9_12=2==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_12=l9_11;
...
bool l9_16=(*sc_set0.UserUniforms).isProxyMode!=0;
if (l9_16)
{
...
float4 l9_17=fast::max(param_53,float4(0.0));
float4 param_54=l9_17;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
float l9_21=l9_20;
float l9_22=l9_21;
float l9_23=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_22;
float3 l9_24=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_18.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
...
{
l9_30.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
float4 l9_31=l9_30;
l9_28=l9_31;
}
...
float2 l9_33=l9_32.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
float2 l9_34=l9_33;
...
float l9_70=l9_62;
float4 l9_71=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_69,bias(l9_70));
float4 l9_72=l9_71;
l9_58=l9_72;
float4 l9_73=l9_58;
float4 l9_74=l9_73;
...
{
l9_28.x+=(*sc_set0.UserUniforms)._sc_GetFramebufferColorInvalidUsageMarker;
}
float4 l9_76=l9_28;
float4 l9_77=l9_76;
...
float3 l9_81=definedBlend(l9_79,l9_80,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
...
{
l9_89=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_89=float4(0.0);
