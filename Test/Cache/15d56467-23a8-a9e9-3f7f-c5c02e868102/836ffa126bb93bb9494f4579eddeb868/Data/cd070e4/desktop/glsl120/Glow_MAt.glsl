...
//spec_const int sc_StereoViewID 85 0
//SG_REFLECTION_END
...
float l9_29=snoise(vec2(floor((sc_Time.x*Port_Multiplier_N012)*10000.0)*9.9999997e-05)*(Port_Scale_N013*0.5));
float l9_30=((glow_scale*Port_Input1_N021)/(Port_Input1_N019+1.234e-06))+Port_Input1_N020;
vec3 l9_31;
vec3 l9_32;
vec3 l9_33;
if (l9_25)
...
l9_33=varTangent.xyz;
l9_32=l9_28;
l9_31=(sc_ModelMatrix*vec4(((sc_ModelMatrixInverse*vec4(varPos,1.0)).xyz*vec3(((((floor(((l9_29*0.5)+0.5)*10000.0)*9.9999997e-05)-Port_RangeMinA_N015)/((Port_RangeMaxA_N015-Port_RangeMinA_N015)+1e-06))*(Port_RangeMaxB_N015-Port_RangeMinB_N015))+Port_RangeMinB_N015))*vec3(Port_Value1_N018,((((Port_ValueIn_N035-vec4(Port_RangeMinA_N035))/vec4((Port_RangeMaxA_N035-Port_RangeMinA_N035)+1e-06))*((l9_30+Port_Input1_N017)-l9_30))+vec4(l9_30)).x,Port_Value3_N018),1.0)).xyz;
}
varPos=l9_31;
...
#endif
l9_26=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_30,sc_ScreenTextureLayout,l9_31).xy,0.0);
}
#endif
vec4 l9_32;
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_45-0.0039215689)),min(1.0,l9_45+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_47),packValue(l9_47),packValue(l9_47),packValue(l9_47)),sc_UniformConstants.x,sc_ShaderCacheConstant);
...
sc_writeFragData0Internal(l9_44,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
{
sc_writeFragData0Internal(l9_43,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif
