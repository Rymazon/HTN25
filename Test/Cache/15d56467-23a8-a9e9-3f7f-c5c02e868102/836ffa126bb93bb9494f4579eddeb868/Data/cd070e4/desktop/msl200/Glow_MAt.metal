...
//float glow_scale 4128
//float Port_Multiplier_N012 4132
//float2 Port_Scale_N013 4136
//float Port_RangeMinA_N015 4144
//float Port_RangeMaxA_N015 4148
//float Port_RangeMinB_N015 4152
//float Port_RangeMaxB_N015 4156
//float Port_Value1_N018 4160
//float4 Port_ValueIn_N035 4176
//float Port_RangeMinA_N035 4192
//float Port_RangeMaxA_N035 4196
//float Port_Input1_N021 4200
//float Port_Input1_N019 4204
//float Port_Input1_N020 4208
//float Port_Input1_N017 4212
//float Port_Value3_N018 4216
//float Port_Input0_N003 4220
//float Port_Input1_N003 4224
//float2 Port_Scale_N006 4232
//float2 Port_Center_N006 4240
//float2 Port_Input1_N000 4248
//float4 Port_Value0_N005 4256
//float Port_Position1_N005 4272
//float4 Port_Value1_N005 4288
//float4 Port_Value2_N005 4304
//float Port_Input0_N009 4320
//float Port_Input1_N009 4324
//float Port_Input0_N016 4328
//float Port_Input1_N016 4332
//float Port_Input0_N022 4336
//float Port_Input1_N022 4340
//}
...
param_1*=(param_2*0.5);
float2 l9_119=param_1;
float param_3=(snoise(l9_119)*0.5)+0.5;
...
int l9_124=l9_123;
l9_122=(*sc_set0.UserUniforms).sc_ProjectionMatrixInverseArray[l9_124]*l9_121;
}
else
{
if (sc_RenderingSpace_tmp==2)
...
int l9_126=l9_125;
l9_122=(*sc_set0.UserUniforms).sc_ViewMatrixArray[l9_126]*l9_121;
}
else
{
if (sc_RenderingSpace_tmp==1)
...
int l9_128=l9_127;
l9_122=(*sc_set0.UserUniforms).sc_ModelViewMatrixArray[l9_128]*l9_121;
}
else
{
l9_122=l9_121;
...
float4 l9_129=l9_122;
out.varViewSpaceDepth=-l9_129.z;
}
...
int l9_132=l9_131;
l9_130=((*sc_set0.UserUniforms).sc_ModelViewMatrixArray[l9_132]*param_5.position)*float4(1.0/(*sc_set0.UserUniforms).sc_Camera.aspect,1.0,1.0,1.0);
}
else
{
if (sc_RenderingSpace_tmp==2)
...
int l9_134=l9_133;
l9_130=(*sc_set0.UserUniforms).sc_ViewProjectionMatrixArray[l9_134]*float4(out.varPos,1.0);
}
else
{
if (sc_RenderingSpace_tmp==1)
...
int l9_136=l9_135;
l9_130=(*sc_set0.UserUniforms).sc_ViewProjectionMatrixArray[l9_136]*float4(out.varPos,1.0);
}
}
}
}
...
{
float4 l9_137=param_5.position;
float4 l9_138=l9_137;
if (sc_RenderingSpace_tmp==1)
{
l9_138=(*sc_set0.UserUniforms).sc_ModelMatrix*l9_137;
}
float4 l9_139=(*sc_set0.UserUniforms).sc_ProjectorMatrix*l9_138;
float2 l9_140=((l9_139.xy/float2(l9_139.w))*0.5)+float2(0.5);
out.varShadowTex=l9_140;
}
float4 l9_141=l9_130;
...
int l9_143=l9_142;
if ((*sc_set0.UserUniforms).sc_ProjectionMatrixArray[l9_143][2].w!=0.0)
{
float l9_144=2.0/log2((*sc_set0.UserUniforms).sc_Camera.clipPlanes.y+1.0);
l9_141.z=((log2(fast::max((*sc_set0.UserUniforms).sc_Camera.clipPlanes.x,1.0+l9_141.w))*l9_144)-1.0)*l9_141.w;
}
}
float4 l9_145=l9_141;
l9_130=l9_145;
float4 l9_146=l9_130;
if ((int(sc_TAAEnabled_tmp)!=0))
{
float2 l9_147=l9_146.xy+((*sc_set0.UserUniforms).sc_TAAJitterOffset*l9_146.w);
l9_146=float4(l9_147.x,l9_147.y,l9_146.z,l9_146.w);
}
float4 l9_148=l9_146;
l9_130=l9_148;
float4 l9_149=l9_130;
...
{
float4 l9_17=out.FragColor0;
float4 l9_18=l9_17;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_18.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
float4 l9_19=l9_18;
l9_16=l9_19;
}
...
float2 l9_21=l9_20.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
float2 l9_22=l9_21;
...
int l9_26=l9_25;
int l9_27=l9_26;
float3 l9_28=float3(l9_22,0.0);
int l9_29=l9_24;
int l9_30=l9_27;
if (l9_29==1)
{
l9_28.y=((2.0*l9_28.y)+float(l9_30))-1.0;
}
float2 l9_31=l9_28.xy;
l9_23=l9_31;
}
else
{
...
float2 l9_47=l9_43;
int l9_48=sc_ScreenTextureLayout_tmp;
int l9_49=l9_44;
float l9_50=l9_45;
float2 l9_51=l9_47;
int l9_52=l9_48;
...
float3 l9_55=l9_54;
float3 l9_56=l9_55;
float2 l9_57=l9_56.xy;
float l9_58=l9_50;
float4 l9_59=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_57,bias(l9_58));
float4 l9_60=l9_59;
l9_46=l9_60;
float4 l9_61=l9_46;
float4 l9_62=l9_61;
...
{
l9_16.x+=(*sc_set0.UserUniforms)._sc_GetFramebufferColorInvalidUsageMarker;
}
float4 l9_64=l9_16;
float4 l9_65=l9_64;
float3 l9_66=l9_65.xyz;
float3 l9_67=l9_66;
float3 l9_68=l9_14.xyz;
float3 l9_69=definedBlend(l9_67,l9_68,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_15=float4(l9_69.x,l9_69.y,l9_69.z,l9_15.w);
float3 l9_70=mix(l9_66,l9_15.xyz,float3(l9_14.w));
l9_15=float4(l9_70.x,l9_70.y,l9_70.z,l9_15.w);
l9_15.w=1.0;
float4 l9_71=l9_15;
param_8=l9_71;
}
...
{
l9_77=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_77=float4(0.0);
...
float4 l9_79=param_11;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_79.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_79;
return out;
}
} // FRAGMENT SHADER
