...
//sampler sampler glow_mapSmpSC 0:22
...
//texture texture2D glow_map 0:4:0:22
...
//float3x3 glow_mapTransform 4320
//float4 glow_mapUvMinMax 4368
//float4 glow_mapBorderColor 4384
//float2 Port_Offset_N009 4400
//float4 Port_Value0_N007 4416
//float Port_Position1_N007 4432
//float4 Port_Value1_N007 4448
//float Port_Position2_N007 4464
//float4 Port_Value2_N007 4480
//float4 Port_Value3_N007 4496
//float Port_Input1_N003 4512
//float depthRef 4516
//}
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_glow_map 74 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 75 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_glow_map 76 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 77 -1
//spec_const int glow_mapLayout 78 0
...
constant bool SC_USE_CLAMP_TO_BORDER_glow_map [[function_constant(31)]];
...
constant bool SC_USE_UV_MIN_MAX_glow_map [[function_constant(33)]];
...
constant bool SC_USE_UV_TRANSFORM_glow_map [[function_constant(35)]];
...
constant bool glow_mapHasSwappedViews [[function_constant(38)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_glow_map [[function_constant(74)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_glow_map [[function_constant(76)]];
...
constant int glow_mapLayout [[function_constant(78)]];
...
CoordsOut_N9=UVCoord_N12+(*sc_set0.UserUniforms).Port_Offset_N009;
...
float3x3 param_4=(*sc_set0.UserUniforms).glow_mapTransform;
...
float4 param_7=(*sc_set0.UserUniforms).glow_mapUvMinMax;
bool param_8=(int(SC_USE_CLAMP_TO_BORDER_glow_map_tmp)!=0);
float4 param_9=(*sc_set0.UserUniforms).glow_mapBorderColor;
float param_10=0.0;
bool l9_11=param_8&&(!param_6);
float l9_12=1.0;
float l9_13=param_2.x;
int l9_14=param_5.x;
if (l9_14==1)
{
l9_13=fract(l9_13);
...
float l9_25=param_2.x;
float l9_26=param_7.x;
float l9_27=param_7.z;
bool l9_28=l9_24;
float l9_29=l9_12;
...
float l9_34=param_2.y;
float l9_35=param_7.y;
float l9_36=param_7.w;
bool l9_37=l9_33;
float l9_38=l9_12;
...
float2 l9_41=param_2;
bool l9_42=param_3;
float3x3 l9_43=param_4;
if (l9_42)
{
...
param_2.y=l9_58;
l9_12=l9_61;
float2 l9_69=param_2;
int l9_70=param;
int l9_71=param_1;
float l9_72=param_10;
float2 l9_73=l9_69;
int l9_74=l9_70;
int l9_75=l9_71;
...
float l9_80=l9_72;
float4 l9_81=sc_set0.glow_map.sample(sc_set0.glow_mapSmpSC,l9_79,bias(l9_80));
float4 l9_82=l9_81;
float4 l9_83=l9_82;
if (param_8)
{
l9_83=mix(param_9,l9_83,float4(l9_12));
}
float4 l9_84=l9_83;
Color_N1=l9_84;
float4 Value_N7=float4(0.0);
float param_11=Color_N1.x;
float4 param_12=(*sc_set0.UserUniforms).Port_Value0_N007;
float param_13=(*sc_set0.UserUniforms).Port_Position1_N007;
float4 param_14=(*sc_set0.UserUniforms).Port_Value1_N007;
float param_15=(*sc_set0.UserUniforms).Port_Position2_N007;
float4 param_16=(*sc_set0.UserUniforms).Port_Value2_N007;
float4 param_17=(*sc_set0.UserUniforms).Port_Value3_N007;
...
bool l9_85=(*sc_set0.UserUniforms).PreviewEnabled==1;
bool l9_86;
if (l9_85)
{
l9_86=!PreviewInfo.Saved;
}
else
{
l9_86=l9_85;
...
if (l9_86)
{
l9_87=7==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_87=l9_86;
...
Output_N3=float4(float(Value_N7.x<(*sc_set0.UserUniforms).Port_Input1_N003),float(Value_N7.y<(*sc_set0.UserUniforms).Port_Input1_N003),float(Value_N7.z<(*sc_set0.UserUniforms).Port_Input1_N003),float(Value_N7.w<(*sc_set0.UserUniforms).Port_Input1_N003));
...
float4 l9_92=fast::max(param_23,float4(0.0));
float4 param_24=l9_92;
if (sc_ShaderCacheConstant_tmp!=0)
{
