...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N6 78 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 79 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_planet_refl_map 80 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N6 81 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 82 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_planet_refl_map 83 -1
//spec_const int Tweak_N6Layout 84 0
//spec_const int intensityTextureLayout 85 0
//spec_const int planet_refl_mapLayout 86 0
...
constant bool Tweak_N6HasSwappedViews [[function_constant(40)]];
...
constant bool planet_refl_mapHasSwappedViews [[function_constant(43)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N6 [[function_constant(78)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_planet_refl_map [[function_constant(80)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N6 [[function_constant(81)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_planet_refl_map [[function_constant(83)]];
...
constant int Tweak_N6Layout [[function_constant(84)]];
...
constant int planet_refl_mapLayout [[function_constant(86)]];
...
float param_17=(*sc_set0.UserUniforms).Port_Rotation_N003;
float2 param_18=(*sc_set0.UserUniforms).Port_Center_N003;
float l9_99=sin(radians(param_17));
float l9_100=cos(radians(param_17));
float2 param_19=param_16-param_18;
param_19=float2(dot(float2(l9_100,l9_99),param_19),dot(float2(-l9_99,l9_100),param_19))+param_18;
CoordsOut_N3=param_19;
float4 Output_N2=float4(0.0);
float4 param_20=(*sc_set0.UserUniforms).Tweak_N2;
Output_N2=param_20;
float Output_N12=0.0;
float param_21=(*sc_set0.UserUniforms).colorRatio;
Output_N12=param_21;
float4 Output_N8=float4(0.0);
float4 param_22=(*sc_set0.UserUniforms).Tweak_N8;
Output_N8=param_22;
float4 Output_N9=float4(0.0);
float4 param_23=(*sc_set0.UserUniforms).Tweak_N9;
Output_N9=param_23;
...
if (l9_102)
{
l9_103=0==(*sc_set0.UserUniforms).PreviewNodeID;
}
else
{
l9_103=l9_102;
...
float3x3 param_34=(*sc_set0.UserUniforms).Tweak_N6Transform;
...
float4 param_37=(*sc_set0.UserUniforms).Tweak_N6UvMinMax;
bool param_38=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6_tmp)!=0);
float4 param_39=(*sc_set0.UserUniforms).Tweak_N6BorderColor;
float param_40=0.0;
bool l9_110=param_38&&(!param_36);
float l9_111=1.0;
float l9_112=param_32.x;
int l9_113=param_35.x;
if (l9_113==1)
{
l9_112=fract(l9_112);
}
...
param_32.x=l9_112;
float l9_117=param_32.y;
int l9_118=param_35.y;
if (l9_118==1)
{
l9_117=fract(l9_117);
}
...
float l9_124=param_32.x;
float l9_125=param_37.x;
float l9_126=param_37.z;
bool l9_127=l9_123;
float l9_128=l9_111;
...
float l9_133=param_32.y;
float l9_134=param_37.y;
float l9_135=param_37.w;
bool l9_136=l9_132;
float l9_137=l9_111;
...
float2 l9_140=param_32;
bool l9_141=param_33;
float3x3 l9_142=param_34;
if (l9_141)
{
...
param_32=l9_145;
float l9_146=param_32.x;
int l9_147=param_35.x;
bool l9_148=l9_110;
float l9_149=l9_111;
...
param_32.x=l9_146;
l9_111=l9_149;
float l9_157=param_32.y;
int l9_158=param_35.y;
bool l9_159=l9_110;
float l9_160=l9_111;
...
param_32.y=l9_157;
l9_111=l9_160;
float2 l9_168=param_32;
int l9_169=param_30;
int l9_170=param_31;
float l9_171=param_40;
...
float2 l9_178=l9_177.xy;
float l9_179=l9_171;
float4 l9_180=sc_set0.Tweak_N6.sample(sc_set0.Tweak_N6SmpSC,l9_178,bias(l9_179));
float4 l9_181=l9_180;
float4 l9_182=l9_181;
if (param_38)
{
l9_182=mix(param_39,l9_182,float4(l9_111));
}
...
float3 l9_184=param_42.xyz*param_41.xyz;
float4 param_43;
param_43=float4(l9_184.x,l9_184.y,l9_184.z,param_43.w);
float3 l9_185=mix(param_41.xyz,param_43.xyz,float3(param_42.w));
param_43=float4(l9_185.x,l9_185.y,l9_185.z,param_43.w);
...
float2 l9_187=floor(mod(l9_186.xy,float2(4.0)));
float l9_188=(mod(dot(l9_187,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_44<l9_188)
{
discard_fragment();
}
}
bool l9_189=(*sc_set0.UserUniforms).isProxyMode!=0;
if (l9_189)
{
...
float4 l9_190=fast::max(param_45,float4(0.0));
float4 param_46=l9_190;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
float4 l9_199=param_47;
float4 l9_200=float4(0.0);
float4 l9_201=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_202=out.FragColor0;
float4 l9_203=l9_202;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_203.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
float4 l9_204=l9_203;
l9_201=l9_204;
}
...
{
float4 l9_205=gl_FragCoord;
float2 l9_206=l9_205.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_211=l9_210;
int l9_212=l9_211;
float3 l9_213=float3(l9_207,0.0);
int l9_214=l9_209;
int l9_215=l9_212;
if (l9_214==1)
{
l9_213.y=((2.0*l9_213.y)+float(l9_215))-1.0;
}
float2 l9_216=l9_213.xy;
l9_208=l9_216;
}
else
{
...
int l9_233=sc_ScreenTextureLayout_tmp;
int l9_234=l9_229;
float l9_235=l9_230;
...
float l9_243=l9_235;
float4 l9_244=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_242,bias(l9_243));
float4 l9_245=l9_244;
l9_231=l9_245;
float4 l9_246=l9_231;
...
{
l9_201.x+=(*sc_set0.UserUniforms)._sc_GetFramebufferColorInvalidUsageMarker;
}
float4 l9_249=l9_201;
float4 l9_250=l9_249;
float3 l9_251=l9_250.xyz;
float3 l9_252=l9_251;
float3 l9_253=l9_199.xyz;
float3 l9_254=definedBlend(l9_252,l9_253,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_200=float4(l9_254.x,l9_254.y,l9_254.z,l9_200.w);
float3 l9_255=mix(l9_251,l9_200.xyz,float3(l9_199.w));
l9_200=float4(l9_255.x,l9_255.y,l9_255.z,l9_200.w);
l9_200.w=1.0;
float4 l9_256=l9_200;
param_47=l9_256;
}
else
{
float4 l9_257=param_47;
float4 l9_258=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_258=float4(mix(float3(1.0),l9_257.xyz,float3(l9_257.w)),l9_257.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_259=l9_257.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_259=fast::clamp(l9_259,0.0,1.0);
}
l9_258=float4(l9_257.xyz*l9_259,l9_259);
}
else
{
l9_258=l9_257;
...
float4 l9_260=l9_258;
param_47=l9_260;
}
}
}
float4 l9_261=param_47;
FinalColor=l9_261;
if ((*sc_set0.UserUniforms).PreviewEnabled==1)
{
if (PreviewInfo.Saved)
...
{
l9_262=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_262=float4(0.0);
...
float4 l9_264=param_50;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_264.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_264;
return out;
}
} // FRAGMENT SHADER
