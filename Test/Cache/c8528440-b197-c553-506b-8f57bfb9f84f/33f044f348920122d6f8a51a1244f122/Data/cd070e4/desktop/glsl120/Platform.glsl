...
//spec_const bool sc_ShaderComplexityAnalyzer 77 0
//spec_const bool sc_TAAEnabled 78 0
//spec_const bool sc_UseFramebufferFetchMarker 79 0
//spec_const bool sc_VertexBlending 80 0
//spec_const bool sc_VertexBlendingUseNormals 81 0
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N6 82 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 83 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_planet_refl_map 84 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N6 85 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 86 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_planet_refl_map 87 -1
//spec_const int Tweak_N6Layout 88 0
//spec_const int intensityTextureLayout 89 0
//spec_const int planet_refl_mapLayout 90 0
...
vec2 l9_6=((mat3(vec3(l9_4.x,l9_5.x,l9_3.x),vec3(l9_4.y,l9_5.y,l9_3.y),vec3(l9_4.z,l9_5.z,l9_3.z))*normalize(mat3(l9_2,cross(l9_1,l9_2)*varTangent.w,l9_1)*Port_Import_N013)).xy*0.5)+vec2(0.5);
int l9_7;
...
#endif
bool l9_8=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0)&&(!(int(SC_USE_UV_MIN_MAX_planet_refl_map)!=0));
float l9_9=l9_6.x;
sc_SoftwareWrapEarly(l9_9,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x);
float l9_10=l9_9;
float l9_11=l9_6.y;
sc_SoftwareWrapEarly(l9_11,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y);
float l9_12=l9_11;
vec2 l9_13;
float l9_14;
...
{
l9_15=ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x==3;
}
#else
{
l9_15=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0);
}
#endif
float l9_16=l9_10;
float l9_17=1.0;
sc_ClampUV(l9_16,planet_refl_mapUvMinMax.x,planet_refl_mapUvMinMax.z,l9_15,l9_17);
float l9_18=l9_16;
float l9_19=l9_17;
bool l9_20;
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
l9_20=ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y==3;
}
#else
{
l9_20=(int(SC_USE_CLAMP_TO_BORDER_planet_refl_map)!=0);
}
#endif
float l9_21=l9_12;
float l9_22=l9_19;
sc_ClampUV(l9_21,planet_refl_mapUvMinMax.y,planet_refl_mapUvMinMax.w,l9_20,l9_22);
l9_14=l9_22;
...
#endif
vec2 l9_23=sc_TransformUV(l9_13,(int(SC_USE_UV_TRANSFORM_planet_refl_map)!=0),planet_refl_mapTransform);
float l9_24=l9_23.x;
float l9_25=l9_14;
sc_SoftwareWrapLate(l9_24,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).x,l9_8,l9_25);
float l9_26=l9_23.y;
float l9_27=l9_25;
sc_SoftwareWrapLate(l9_26,ivec2(SC_SOFTWARE_WRAP_MODE_U_planet_refl_map,SC_SOFTWARE_WRAP_MODE_V_planet_refl_map).y,l9_8,l9_27);
float l9_28=l9_27;
vec3 l9_29=sc_SamplingCoordsViewToGlobal(vec2(l9_24,l9_26),planet_refl_mapLayout,l9_7);
vec4 l9_30=texture2D(planet_refl_map,l9_29.xy,0.0);
vec4 l9_31;
#if (SC_USE_CLAMP_TO_BORDER_planet_refl_map)
{
l9_31=mix(planet_refl_mapBorderColor,l9_30,vec4(l9_28));
}
#else
{
l9_31=l9_30;
...
#endif
vec4 l9_32=vec4(reflIntensity)*l9_31;
float l9_33=radians(Port_Rotation_N003);
float l9_34=clamp((vec2(dot(vec2(cos(l9_33),sin(l9_33)),varPackedTex.zw-Port_Center_N003),0.0)+Port_Center_N003).x,0.0,1.0);
vec4 l9_35;
if (l9_34<colorRatio)
{
l9_35=mix(Tweak_N2,Tweak_N8,vec4(clamp(l9_34/colorRatio,0.0,1.0)));
}
else
{
l9_35=mix(Tweak_N8,Tweak_N9,vec4(clamp((l9_34-colorRatio)/(1.0-colorRatio),0.0,1.0)));
}
...
#endif
bool l9_43=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N6)!=0));
float l9_44=varPackedTex.x;
sc_SoftwareWrapEarly(l9_44,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x);
float l9_45=l9_44;
float l9_46=varPackedTex.y;
sc_SoftwareWrapEarly(l9_46,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y);
float l9_47=l9_46;
vec2 l9_48;
float l9_49;
...
{
l9_50=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x==3;
}
#else
{
l9_50=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0);
}
#endif
float l9_51=l9_45;
float l9_52=1.0;
sc_ClampUV(l9_51,Tweak_N6UvMinMax.x,Tweak_N6UvMinMax.z,l9_50,l9_52);
float l9_53=l9_51;
float l9_54=l9_52;
bool l9_55;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_55=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y==3;
}
#else
{
l9_55=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0);
}
#endif
float l9_56=l9_47;
float l9_57=l9_54;
sc_ClampUV(l9_56,Tweak_N6UvMinMax.y,Tweak_N6UvMinMax.w,l9_55,l9_57);
l9_49=l9_57;
...
#endif
vec2 l9_58=sc_TransformUV(l9_48,(int(SC_USE_UV_TRANSFORM_Tweak_N6)!=0),Tweak_N6Transform);
float l9_59=l9_58.x;
float l9_60=l9_49;
sc_SoftwareWrapLate(l9_59,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x,l9_43,l9_60);
float l9_61=l9_58.y;
float l9_62=l9_60;
sc_SoftwareWrapLate(l9_61,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y,l9_43,l9_62);
float l9_63=l9_62;
vec3 l9_64=sc_SamplingCoordsViewToGlobal(vec2(l9_59,l9_61),Tweak_N6Layout,l9_42);
vec4 l9_65=texture2D(Tweak_N6,l9_64.xy,0.0);
vec4 l9_66;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_66=mix(Tweak_N6BorderColor,l9_65,vec4(l9_63));
}
#else
{
l9_66=l9_65;
...
#endif
vec3 l9_67=l9_41.xyz;
vec3 l9_68=mix(l9_67,(l9_66.xyz*l9_67).xyz,vec3(l9_66.w));
float l9_69=l9_41.w;
...
{
l9_74=clamp(dot(l9_70.xyz,vec3(l9_69)),0.0,1.0);
}
#else
{
float l9_75;
...
{
l9_76=(1.0-dot(l9_70.xyz,vec3(0.33333001)))*l9_69;
}
#else
{
float l9_77;
...
{
l9_77=(1.0-clamp(dot(l9_70.xyz,vec3(1.0)),0.0,1.0))*l9_69;
}
#else
{
float l9_78;
...
{
l9_78=clamp(dot(l9_70.xyz,vec3(1.0)),0.0,1.0)*l9_69;
}
#else
{
float l9_79;
#if (sc_BlendMode_Add)
{
l9_79=clamp(dot(l9_70.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_80;
...
{
l9_81=dot(l9_70.xyz,vec3(0.33333001))*l9_69;
}
#else
{
float l9_82;
#if (sc_BlendMode_Min)
{
l9_82=1.0-clamp(dot(l9_70.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_83;
#if (sc_BlendMode_Max)
{
l9_83=clamp(dot(l9_70.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_83=1.0;
...
#endif
l9_71=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_70.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_72);
}
#else
{
vec4 l9_84;
...
#if (sc_FramebufferFetch)
{
vec4 l9_87=sc_readFragData0_Platform();
vec4 l9_88;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_89=l9_87;
l9_89.x=l9_87.x+_sc_framebufferFetchMarker;
l9_88=l9_89;
}
#else
{
...
#endif
l9_86=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_90,sc_ScreenTextureLayout,l9_91).xy,0.0);
}
#endif
vec4 l9_92;
...
{
vec4 l9_93=l9_86;
l9_93.x=l9_86.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_92=l9_93;
}
#else
{
...
#endif
vec3 l9_94=mix(l9_92.xyz,definedBlend(l9_92.xyz,l9_70.xyz).xyz,vec3(l9_69));
...
{
l9_101=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_101=vec4(0.0);
...
vec4 l9_103=outputMotionVectorsIfNeeded(varPos,max(l9_102,vec4(0.0)));
